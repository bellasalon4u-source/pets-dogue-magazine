...
nl:{
meta:{title:"Gezondheid en verzorging | PETS & DOGUE",description:"Gezondheid, voeding, vachtverzorging, gedrag, eerste hulp, veterinaire informatie en dagelijkse verzorging van PETS & DOGUE."},
hero:{title:"Gezondheid en verzorging",description:"Een premium centrum voor gezondheid, voeding, vachtverzorging, gedrag, eerste hulp en dagelijkse verzorging."},
page:{title:"PETS & DOGUE Centrum voor Gezondheid en Verzorging"},
notice:{title:"Gezondheidsmelding van de redactie",description:"Deze rubriek biedt alleen algemene informatie en vervangt geen veterinair advies. Neem bij medische zorgen altijd contact op met een gekwalificeerde dierenarts."},
cards:{
vet:{badge:"DIERGENEESKUNDE",title:"Dierenartscontroles",description:"Regelmatige controles helpen gezondheidsveranderingen vroeg op te merken en uw huisdier comfortabel te houden.",button:"Dierenartsen zoeken"},
nutrition:{badge:"VOEDING",title:"Voeding en balans",description:"Voeding, hydratatie en dagelijkse eetgewoonten vormen de basis van het welzijn.",button:"Gidsen lezen"},
behaviour:{badge:"GEDRAG",title:"Rustig leven",description:"Routine, zachte aandacht en veilige ruimtes helpen huisdieren zich zeker en veilig te voelen.",button:"Gemeenschap vragen"},
grooming:{badge:"VACHTVERZORGING",title:"Vacht en schoonheid",description:"Vachtverzorging is niet alleen stijl. Het ondersteunt comfort, huidgezondheid en welzijn.",button:"Partneraanbiedingen"},
dental:{badge:"GEBITSVERZORGING",title:"Tanden en adem",description:"Gebitsverzorging ondersteunt eetlust, comfort en langdurig welzijn.",button:"Gebitsgids"},
fitness:{badge:"ACTIVITEIT",title:"Beweging en spel",description:"Beweging, verrijking en spel helpen huisdieren actief, gelukkig en mentaal gestimuleerd te blijven.",button:"Actief reizen"}
},
firstAid:{badge:"EERSTE HULP",title:"Een noodgeval herkennen",descriptionOne:"Elke eigenaar moet waarschuwingssignalen kennen: ademhalingsproblemen, instorten, ernstige bloeding, vergiftiging, herhaald braken, aanvallen of plotseling niet kunnen lopen.",descriptionTwo:"Wacht bij een noodgeval niet op online advies. Neem onmiddellijk contact op met een dierenarts, spoedkliniek of dierengifcentrum.",button:"Lokale hulp vinden"},
checklist:{title:"Controlelijst gezondheid en verzorging",one:"Houd vaccinatie- en microchipgegevens actueel.",two:"Plan regelmatige dierenarts- en gebitscontroles.",three:"Let op eetlust, drinken, gedrag, ademhaling en energie.",four:"Gebruik veilige routines voor huid- en vachtverzorging.",five:"Bewaar de gegevens van een veterinaire spoedkliniek in uw telefoon.",six:"Maak een kleine EHBO-kit voor thuis en op reis.",seven:"Vraag professioneel advies voordat u supplementen, medicijnen of natuurlijke remedies gebruikt."},
emergency:{title:"Wanneer dringend hulp nodig is",description:"Zoek direct veterinaire hulp bij ademhalingsproblemen, vermoeden van vergiftiging, instorten, ernstige pijn, bloeding, aanvallen, hitteberoerte, trauma, opgezwollen buik, herhaald braken of elke plotselinge ernstige verandering.",button:"Dierenartsen in de buurt zoeken"},
club:{title:"Voordelen voor clubleden",description:"De PETS & DOGUE Club verbindt leden met partners voor gezondheid en verzorging, vachtverzorgingsaanbiedingen, verzorgingsgidsen, dieren-spa-voordelen en hoogwaardige aanbevelingen.",grooming:"Kortingen op vachtverzorging",spa:"Dieren-spa-aanbiedingen",guides:"Gidsen voor gezondheid en verzorging",nutrition:"Voedingspartners",vet:"Dierenartsvoordelen",qr:"QR-kaart voor leden",button:"Word lid van de Club"},
footer:{home:"Startpagina",articles:"Artikelen",places:"Plaatsen",partners:"Partners",club:"Club",privacy:"Privacy",contact:"Contact"},
images:{hero:"Gezondheid en verzorging van huisdieren",veterinary:"Dierenartscontrole",nutrition:"Voeding voor huisdieren",behaviour:"Gedrag van huisdieren",grooming:"Vachtverzorging",dental:"Gebitsverzorging",fitness:"Activiteit van huisdieren",firstAid:"Eerste hulp"}
},

pl:{
meta:{title:"Zdrowie i opieka | PETS & DOGUE",description:"Zdrowie zwierząt, żywienie, pielęgnacja, zachowanie, pierwsza pomoc, wiedza weterynaryjna i codzienna opieka od PETS & DOGUE."},
hero:{title:"Zdrowie i opieka",description:"Ekskluzywne centrum zdrowia, żywienia, pielęgnacji, zachowania, pierwszej pomocy i codziennej opieki nad zwierzętami."},
page:{title:"Centrum Zdrowia i Opieki PETS & DOGUE"},
notice:{title:"Nota zdrowotna redakcji",description:"Sekcja zdrowia i opieki PETS & DOGUE zawiera wyłącznie informacje ogólne i nie zastępuje porady weterynaryjnej. W przypadku problemów zdrowotnych zawsze skontaktuj się z wykwalifikowanym weterynarzem."},
cards:{
vet:{badge:"WETERYNARIA",title:"Kontrole weterynaryjne",description:"Regularne kontrole pomagają wcześnie zauważyć zmiany zdrowotne i zapewnić zwierzęciu komfort.",button:"Znajdź weterynarzy"},
nutrition:{badge:"ŻYWIENIE",title:"Jedzenie i równowaga",description:"Żywienie, nawodnienie i codzienne nawyki żywieniowe są podstawą dobrostanu zwierzęcia.",button:"Czytaj przewodniki"},
behaviour:{badge:"ZACHOWANIE",title:"Spokojne życie",description:"Rutyna, łagodna uwaga i bezpieczne miejsca pomagają zwierzętom czuć się pewnie i bezpiecznie.",button:"Zapytaj społeczność"},
grooming:{badge:"PIELĘGNACJA",title:"Sierść i uroda",description:"Pielęgnacja to nie tylko styl. Wspiera komfort, zdrowie skóry i dobre samopoczucie.",button:"Oferty partnerów"},
dental:{badge:"PIELĘGNACJA ZĘBÓW",title:"Zęby i oddech",description:"Higiena jamy ustnej wspiera apetyt, komfort i długotrwałe zdrowie.",button:"Przewodnik dentystyczny"},
fitness:{badge:"AKTYWNOŚĆ",title:"Ruch i zabawa",description:"Ruch, zajęcia rozwijające i zabawa pomagają zwierzętom być aktywnymi, szczęśliwymi i stymulowanymi.",button:"Aktywne podróże"}
},
firstAid:{badge:"PIERWSZA POMOC",title:"Rozpoznawanie nagłego przypadku",descriptionOne:"Każdy opiekun powinien znać podstawowe sygnały alarmowe: problemy z oddychaniem, omdlenie, silne krwawienie, zatrucie, powtarzające się wymioty, drgawki lub nagła niemożność chodzenia.",descriptionTwo:"W nagłym przypadku nie czekaj na poradę online. Natychmiast skontaktuj się z weterynarzem, kliniką całodobową lub ośrodkiem toksykologicznym dla zwierząt.",button:"Znajdź pomoc lokalną"},
checklist:{title:"Lista zdrowia i opieki",one:"Aktualizuj informacje o szczepieniach i mikrochipie.",two:"Umawiaj regularne kontrole weterynaryjne i dentystyczne.",three:"Obserwuj apetyt, picie, zachowanie, oddychanie i energię.",four:"Stosuj bezpieczne rutyny pielęgnacji skóry i sierści.",five:"Zapisz w telefonie dane kliniki weterynaryjnej 24h.",six:"Przygotuj małą apteczkę pierwszej pomocy do domu i podróży.",seven:"Skonsultuj się ze specjalistą przed użyciem suplementów, leków lub naturalnych środków."},
emergency:{title:"Kiedy szukać pilnej pomocy",description:"Pilnie skontaktuj się z weterynarzem w przypadku problemów z oddychaniem, podejrzenia zatrucia, omdlenia, silnego bólu, krwawienia, drgawek, udaru cieplnego, urazu, wzdętego brzucha, powtarzających się wymiotów lub nagłej poważnej zmiany.",button:"Znajdź weterynarzy w pobliżu"},
club:{title:"Korzyści dla członków Klubu",description:"Klub PETS & DOGUE połączy członków z partnerami zdrowia i opieki, ofertami pielęgnacji, przewodnikami opieki, korzyściami spa dla zwierząt i wybranymi rekomendacjami premium.",grooming:"Zniżki na pielęgnację",spa:"Oferty spa dla zwierząt",guides:"Przewodniki zdrowia i opieki",nutrition:"Partnerzy żywieniowi",vet:"Korzyści weterynaryjne",qr:"Karta QR członka",button:"Dołącz do Klubu"},
footer:{home:"Strona główna",articles:"Artykuły",places:"Miejsca",partners:"Partnerzy",club:"Klub",privacy:"Prywatność",contact:"Kontakt"},
images:{hero:"Zdrowie i opieka nad zwierzętami",veterinary:"Kontrola weterynaryjna",nutrition:"Żywienie zwierząt",behaviour:"Zachowanie zwierząt",grooming:"Pielęgnacja",dental:"Pielęgnacja zębów",fitness:"Aktywność zwierząt",firstAid:"Pierwsza pomoc"}
},

cs:{
meta:{title:"Zdraví a péče | PETS & DOGUE",description:"Zdraví zvířat, výživa, péče o srst, chování, první pomoc, veterinární informace a každodenní péče od PETS & DOGUE."},
hero:{title:"Zdraví a péče",description:"Prémiové centrum zdraví zvířat, výživy, péče o srst, chování, první pomoci a každodenní péče."},
page:{title:"Centrum zdraví a péče PETS & DOGUE"},
notice:{title:"Zdravotní poznámka redakce",description:"Sekce zdraví a péče PETS & DOGUE poskytuje pouze obecné informace. Nenahrazuje veterinární radu. Při zdravotních potížích vždy kontaktujte kvalifikovaného veterináře."},
cards:{
vet:{badge:"VETERINÁRNÍ PÉČE",title:"Veterinární kontroly",description:"Pravidelné kontroly pomáhají včas zaznamenat změny zdravotního stavu a udržet zvíře v pohodlí.",button:"Najít veterináře"},
nutrition:{badge:"VÝŽIVA",title:"Jídlo a rovnováha",description:"Výživa, hydratace a každodenní stravovací návyky jsou základem zdraví zvířete.",button:"Číst průvodce"},
behaviour:{badge:"CHOVÁNÍ",title:"Klidný život",description:"Rutina, jemná pozornost a bezpečná místa pomáhají zvířatům cítit se sebejistě a bezpečně.",button:"Zeptat se komunity"},
grooming:{badge:"PÉČE O SRST",title:"Srst a krása",description:"Péče o srst není jen styl. Podporuje pohodlí, zdraví pokožky a dobrý pocit.",button:"Partnerské nabídky"},
dental:{badge:"PÉČE O ZUBY",title:"Zuby a dech",description:"Péče o zuby podporuje chuť k jídlu, pohodlí a dlouhodobé zdraví.",button:"Dentální průvodce"},
fitness:{badge:"AKTIVITA",title:"Pohyb a hra",description:"Cvičení, obohacující aktivity a hra pomáhají zvířatům zůstat aktivní, šťastná a mentálně stimulovaná.",button:"Aktivní cestování"}
},
firstAid:{badge:"PRVNÍ POMOC",title:"Rozpoznání nouze",descriptionOne:"Každý majitel by měl znát hlavní varovné příznaky: potíže s dýcháním, kolaps, silné krvácení, otravu, opakované zvracení, záchvaty nebo náhlou neschopnost chodit.",descriptionTwo:"V nouzi nečekejte na online rady. Okamžitě kontaktujte veterináře, pohotovostní kliniku nebo toxikologickou linku pro zvířata.",button:"Najít místní pomoc"},
checklist:{title:"Kontrolní seznam zdraví a péče",one:"Udržujte informace o očkování a mikročipu aktuální.",two:"Objednávejte pravidelné veterinární a dentální kontroly.",three:"Sledujte chuť k jídlu, pití, chování, dýchání a energii.",four:"Používejte bezpečné rutiny péče o kůži a srst.",five:"Uložte si do telefonu kontakt na veterinární pohotovost.",six:"Připravte malou lékárničku první pomoci domů i na cesty.",seven:"Před použitím doplňků, léků nebo přírodních prostředků se poraďte s odborníkem."},
emergency:{title:"Kdy vyhledat urgentní pomoc",description:"Urgentně vyhledejte veterináře při potížích s dýcháním, podezření na otravu, kolapsu, silné bolesti, krvácení, záchvatech, úpalu, traumatu, nafouklém břiše, opakovaném zvracení nebo jiné náhlé závažné změně.",button:"Najít veterináře poblíž"},
club:{title:"Výhody pro členy Klubu",description:"Klub PETS & DOGUE propojí členy s partnery pro zdraví a péči, nabídkami péče o srst, průvodci péčí, výhodami spa pro zvířata a prémiovými doporučeními.",grooming:"Slevy na péči o srst",spa:"Nabídky spa pro zvířata",guides:"Průvodci zdravím a péčí",nutrition:"Partneři výživy",vet:"Veterinární výhody",qr:"QR karta člena",button:"Přidat se do Klubu"},
footer:{home:"Domů",articles:"Články",places:"Místa",partners:"Partneři",club:"Klub",privacy:"Soukromí",contact:"Kontakt"},
images:{hero:"Zdraví a péče o zvířata",veterinary:"Veterinární kontrola",nutrition:"Výživa zvířat",behaviour:"Chování zvířat",grooming:"Péče o srst",dental:"Péče o zuby",fitness:"Aktivita zvířat",firstAid:"První pomoc"}
},

sk:{
meta:{title:"Zdravie a starostlivosť | PETS & DOGUE",description:"Zdravie zvierat, výživa, starostlivosť o srsť, správanie, prvá pomoc, veterinárne informácie a každodenná starostlivosť od PETS & DOGUE."},
hero:{title:"Zdravie a starostlivosť",description:"Prémiové centrum zdravia zvierat, výživy, starostlivosti o srsť, správania, prvej pomoci a každodennej starostlivosti."},
page:{title:"Centrum zdravia a starostlivosti PETS & DOGUE"},
notice:{title:"Zdravotná poznámka redakcie",description:"Sekcia zdravia a starostlivosti PETS & DOGUE poskytuje len všeobecné informácie. Nenahrádza veterinárnu radu. Pri zdravotných problémoch vždy kontaktujte kvalifikovaného veterinára."},
cards:{
vet:{badge:"VETERINÁRNA STAROSTLIVOSŤ",title:"Veterinárne kontroly",description:"Pravidelné kontroly pomáhajú včas rozpoznať zdravotné zmeny a udržať zviera v pohodlí.",button:"Nájsť veterinárov"},
nutrition:{badge:"VÝŽIVA",title:"Jedlo a rovnováha",description:"Výživa, hydratácia a každodenné stravovacie návyky sú základom zdravia zvieraťa.",button:"Čítať príručky"},
behaviour:{badge:"SPRÁVANIE",title:"Pokojný život",description:"Rutina, jemná pozornosť a bezpečné priestory pomáhajú zvieratám cítiť sa sebavedomo a bezpečne.",button:"Opýtať sa komunity"},
grooming:{badge:"STAROSTLIVOSŤ O SRSŤ",title:"Srsť a krása",description:"Starostlivosť o srsť nie je len štýl. Podporuje pohodlie, zdravie pokožky a dobrý pocit.",button:"Partnerské ponuky"},
dental:{badge:"STAROSTLIVOSŤ O ZUBY",title:"Zuby a dych",description:"Starostlivosť o zuby podporuje chuť do jedla, pohodlie a dlhodobé zdravie.",button:"Dentálny sprievodca"},
fitness:{badge:"AKTIVITA",title:"Pohyb a hra",description:"Pohyb, obohacujúce aktivity a hra pomáhajú zvieratám zostať aktívne, šťastné a mentálne stimulované.",button:"Aktívne cestovanie"}
},
firstAid:{badge:"PRVÁ POMOC",title:"Rozpoznanie núdze",descriptionOne:"Každý majiteľ by mal poznať základné varovné príznaky: problémy s dýchaním, kolaps, silné krvácanie, otravu, opakované vracanie, záchvaty alebo náhlu neschopnosť chodiť.",descriptionTwo:"V núdzi nečakajte na online rady. Okamžite kontaktujte veterinára, pohotovostnú kliniku alebo toxikologickú linku pre zvieratá.",button:"Nájsť miestnu pomoc"},
checklist:{title:"Kontrolný zoznam zdravia a starostlivosti",one:"Udržujte údaje o očkovaní a mikročipe aktuálne.",two:"Objednávajte pravidelné veterinárne a dentálne kontroly.",three:"Sledujte chuť do jedla, pitie, správanie, dýchanie a energiu.",four:"Používajte bezpečné rutiny starostlivosti o kožu a srsť.",five:"Uložte si kontakt na veterinárnu pohotovosť do telefónu.",six:"Pripravte malú lekárničku prvej pomoci domov aj na cesty.",seven:"Pred použitím doplnkov, liekov alebo prírodných prostriedkov sa poraďte s odborníkom."},
emergency:{title:"Kedy vyhľadať urgentnú pomoc",description:"Urgentne vyhľadajte veterinára pri problémoch s dýchaním, podozrení na otravu, kolapse, silnej bolesti, krvácaní, záchvatoch, úpale, traume, nafúknutom bruchu, opakovanom vracaní alebo inej náhlej závažnej zmene.",button:"Nájsť veterinárov v okolí"},
club:{title:"Výhody pre členov Klubu",description:"Klub PETS & DOGUE spojí členov s partnermi pre zdravie a starostlivosť, ponukami starostlivosti o srsť, sprievodcami starostlivosťou, výhodami spa pre zvieratá a prémiovými odporúčaniami.",grooming:"Zľavy na starostlivosť o srsť",spa:"Ponuky spa pre zvieratá",guides:"Sprievodcovia zdravím a starostlivosťou",nutrition:"Partneri výživy",vet:"Veterinárne výhody",qr:"QR karta člena",button:"Pridať sa do Klubu"},
footer:{home:"Domov",articles:"Články",places:"Miesta",partners:"Partneri",club:"Klub",privacy:"Súkromie",contact:"Kontakt"},
images:{hero:"Zdravie a starostlivosť o zvieratá",veterinary:"Veterinárna kontrola",nutrition:"Výživa zvierat",behaviour:"Správanie zvierat",grooming:"Starostlivosť o srsť",dental:"Starostlivosť o zuby",fitness:"Aktivita zvierat",firstAid:"Prvá pomoc"}
},

hu:{
meta:{title:"Egészség és gondozás | PETS & DOGUE",description:"Állategészség, táplálkozás, ápolás, viselkedés, elsősegély, állatorvosi tudatosság és mindennapi gondozás a PETS & DOGUE-tól."},
hero:{title:"Egészség és gondozás",description:"Prémium központ állategészséghez, táplálkozáshoz, ápoláshoz, viselkedéshez, elsősegélyhez és mindennapi gondozáshoz."},
page:{title:"PETS & DOGUE Egészség- és Gondozási Központ"},
notice:{title:"Szerkesztői egészségügyi megjegyzés",description:"A PETS & DOGUE egészség és gondozás része kizárólag általános információkat nyújt. Nem helyettesíti az állatorvosi tanácsot. Egészségügyi probléma esetén mindig forduljon képzett állatorvoshoz."},
cards:{
vet:{badge:"ÁLLATORVOS",title:"Állatorvosi ellenőrzések",description:"A rendszeres vizsgálatok segítenek korán észrevenni az egészségügyi változásokat és fenntartani az állat komfortját.",button:"Állatorvos keresése"},
nutrition:{badge:"TÁPLÁLKOZÁS",title:"Étel és egyensúly",description:"A megfelelő táplálkozás, hidratáció és napi etetési szokások az állat jóllétének alapjai.",button:"Útmutatók olvasása"},
behaviour:{badge:"VISELKEDÉS",title:"Nyugodt élet",description:"A rutin, gyengéd figyelem és biztonságos terek segítenek az állatoknak magabiztosnak és biztonságban érezni magukat.",button:"Közösség kérdezése"},
grooming:{badge:"ÁPOLÁS",title:"Szőrzet és szépség",description:"Az ápolás nem csak stílus. Támogatja a komfortot, a bőr egészségét és a jó közérzetet.",button:"Partnerajánlatok"},
dental:{badge:"FOGÁPOLÁS",title:"Fogak és lehelet",description:"A fogápolás támogatja az étvágyat, a komfortot és a hosszú távú jóllétet.",button:"Fogápolási útmutató"},
fitness:{badge:"AKTIVITÁS",title:"Mozgás és játék",description:"A mozgás, fejlesztő tevékenységek és játék segít aktívnak, boldognak és mentálisan stimuláltnak maradni.",button:"Aktív utazás"}
},
firstAid:{badge:"ELSŐSEGÉLY",title:"Vészhelyzet felismerése",descriptionOne:"Minden gazdinak ismernie kell a fő figyelmeztető jeleket: légzési nehézség, összeesés, erős vérzés, mérgezés, ismételt hányás, rohamok vagy hirtelen járásképtelenség.",descriptionTwo:"Vészhelyzetben ne várjon online tanácsra. Azonnal forduljon állatorvoshoz, sürgősségi klinikához vagy állatmérgezési segélyvonalhoz.",button:"Helyi segítség keresése"},
checklist:{title:"Egészségügyi és gondozási ellenőrzőlista",one:"Tartsa naprakészen az oltási és mikrochipadatokat.",two:"Foglaljon rendszeres állatorvosi és fogászati ellenőrzést.",three:"Figyelje az étvágyat, ivást, viselkedést, légzést és energiaszintet.",four:"Használjon biztonságos bőr- és szőrápolási rutint.",five:"Mentse el telefonjába egy sürgősségi állatorvosi klinika elérhetőségét.",six:"Készítsen kis elsősegélykészletet otthonra és utazáshoz.",seven:"Kiegészítők, gyógyszerek vagy természetes szerek használata előtt kérjen szakmai tanácsot."},
emergency:{title:"Mikor szükséges sürgős segítség",description:"Kérjen sürgős állatorvosi segítséget légzési nehézség, mérgezés gyanúja, összeesés, erős fájdalom, vérzés, rohamok, hőguta, trauma, puffadt has, ismételt hányás vagy bármilyen hirtelen súlyos változás esetén.",button:"Közeli állatorvosok keresése"},
club:{title:"Előnyök a Klub tagjainak",description:"A PETS & DOGUE Klub egészségügyi és gondozási partnerekkel, ápolási ajánlatokkal, gondozási útmutatókkal, állatspa-előnyökkel és prémium ajánlásokkal kapcsolja össze a tagokat.",grooming:"Ápolási kedvezmények",spa:"Állatspa-ajánlatok",guides:"Egészségügyi és gondozási útmutatók",nutrition:"Táplálkozási partnerek",vet:"Állatorvosi előnyök",qr:"Tagi QR-kártya",button:"Csatlakozás a Klubhoz"},
footer:{home:"Kezdőlap",articles:"Cikkek",places:"Helyek",partners:"Partnerek",club:"Klub",privacy:"Adatvédelem",contact:"Kapcsolat"},
images:{hero:"Állategészség és gondozás",veterinary:"Állatorvosi vizsgálat",nutrition:"Állati táplálkozás",behaviour:"Állati viselkedés",grooming:"Ápolás",dental:"Fogápolás",fitness:"Állati aktivitás",firstAid:"Elsősegély"}
},

ro:{
meta:{title:"Sănătate și îngrijire | PETS & DOGUE",description:"Sănătatea animalelor, nutriție, îngrijire, comportament, prim ajutor, informare veterinară și îngrijire zilnică de la PETS & DOGUE."},
hero:{title:"Sănătate și îngrijire",description:"Un centru premium pentru sănătatea animalelor, nutriție, îngrijire, comportament, prim ajutor și îngrijire zilnică."},
page:{title:"Centrul PETS & DOGUE pentru Sănătate și Îngrijire"},
notice:{title:"Notă editorială de sănătate",description:"Secțiunea de sănătate și îngrijire PETS & DOGUE oferă doar informații generale. Nu înlocuiește sfatul veterinar. Pentru probleme medicale, contactați întotdeauna un medic veterinar calificat."},
cards:{
vet:{badge:"VETERINAR",title:"Controale veterinare",description:"Controalele regulate ajută la observarea timpurie a schimbărilor de sănătate și la menținerea confortului animalului.",button:"Găsește veterinari"},
nutrition:{badge:"NUTRIȚIE",title:"Hrană și echilibru",description:"Nutriția, hidratarea și obiceiurile zilnice de hrănire sunt baza stării de bine.",button:"Citește ghiduri"},
behaviour:{badge:"COMPORTAMENT",title:"Viață liniștită",description:"Rutina, atenția blândă și spațiile sigure ajută animalele să se simtă încrezătoare și protejate.",button:"Întreabă comunitatea"},
grooming:{badge:"ÎNGRIJIRE",title:"Blană și frumusețe",description:"Îngrijirea nu este doar stil. Susține confortul, sănătatea pielii și starea de bine.",button:"Oferte parteneri"},
dental:{badge:"ÎNGRIJIRE DENTARĂ",title:"Dinți și respirație",description:"Îngrijirea dentară susține pofta de mâncare, confortul și bunăstarea pe termen lung.",button:"Ghid dentar"},
fitness:{badge:"ACTIVITATE",title:"Mișcare și joacă",description:"Exercițiul, activitățile de stimulare și joaca ajută animalele să rămână active, fericite și stimulate mental.",button:"Călătorii active"}
},
firstAid:{badge:"PRIM AJUTOR",title:"Recunoașterea unei urgențe",descriptionOne:"Fiecare proprietar trebuie să cunoască semnele de alarmă: dificultăți de respirație, colaps, sângerare severă, otrăvire, vărsături repetate, convulsii sau incapacitatea bruscă de a merge.",descriptionTwo:"Într-o urgență nu așteptați sfaturi online. Contactați imediat un veterinar, o clinică de urgență sau un serviciu de toxicologie veterinară.",button:"Găsește ajutor local"},
checklist:{title:"Lista de sănătate și îngrijire",one:"Păstrați actualizate informațiile despre vaccinare și microcip.",two:"Programați controale veterinare și dentare regulate.",three:"Monitorizați apetitul, consumul de apă, comportamentul, respirația și energia.",four:"Folosiți rutine sigure de îngrijire a pielii și blănii.",five:"Salvați în telefon datele unei clinici veterinare de urgență.",six:"Pregătiți o mică trusă de prim ajutor pentru casă și călătorii.",seven:"Cereți sfatul profesioniștilor înainte de suplimente, medicamente sau remedii naturale."},
emergency:{title:"Când este nevoie de ajutor urgent",description:"Solicitați urgent ajutor veterinar pentru dificultăți de respirație, suspiciune de otrăvire, colaps, durere severă, sângerare, convulsii, insolație, traumă, abdomen umflat, vărsături repetate sau orice schimbare gravă bruscă.",button:"Găsește veterinari în apropiere"},
club:{title:"Beneficii pentru membrii Clubului",description:"Clubul PETS & DOGUE va conecta membrii cu parteneri de sănătate și îngrijire, oferte de îngrijire, ghiduri, beneficii spa pentru animale și recomandări premium.",grooming:"Reduceri pentru îngrijire",spa:"Oferte spa pentru animale",guides:"Ghiduri de sănătate și îngrijire",nutrition:"Parteneri nutriție",vet:"Beneficii veterinare",qr:"Card QR de membru",button:"Intră în Club"},
footer:{home:"Acasă",articles:"Articole",places:"Locuri",partners:"Parteneri",club:"Club",privacy:"Confidențialitate",contact:"Contact"},
images:{hero:"Sănătate și îngrijire pentru animale",veterinary:"Control veterinar",nutrition:"Nutriție animală",behaviour:"Comportament animal",grooming:"Îngrijire",dental:"Îngrijire dentară",fitness:"Activitate pentru animale",firstAid:"Prim ajutor"}
},bg:{
meta:{title:"Здраве и грижа | PETS & DOGUE",description:"Здраве на животните, хранене, грижа за козината, поведение, първа помощ, ветеринарна информираност и ежедневна грижа от PETS & DOGUE."},
hero:{title:"Здраве и грижа",description:"Премиум център за здраве, хранене, грижа за козината, поведение, първа помощ и ежедневна грижа за животните."},
page:{title:"Център за здраве и грижа PETS & DOGUE"},
notice:{title:"Здравна бележка от редакцията",description:"Разделът за здраве и грижа на PETS & DOGUE предоставя само обща информация и не замества ветеринарен съвет. При медицински проблем винаги се обръщайте към квалифициран ветеринарен лекар."},
cards:{
vet:{badge:"ВЕТЕРИНАРИЯ",title:"Ветеринарни прегледи",description:"Редовните прегледи помагат рано да се открият промени в здравето и да се запази комфортът на животното.",button:"Намери ветеринари"},
nutrition:{badge:"ХРАНЕНЕ",title:"Храна и баланс",description:"Храненето, хидратацията и ежедневните навици са основата на доброто състояние.",button:"Прочети ръководства"},
behaviour:{badge:"ПОВЕДЕНИЕ",title:"Спокоен живот",description:"Рутината, нежното внимание и сигурните пространства помагат на животните да се чувстват уверени и защитени.",button:"Попитай общността"},
grooming:{badge:"ГРИЖА ЗА КОЗИНАТА",title:"Козина и красота",description:"Грижата за козината не е само стил. Тя подкрепя комфорта, здравето на кожата и доброто състояние.",button:"Партньорски предложения"},
dental:{badge:"ГРИЖА ЗА ЗЪБИТЕ",title:"Зъби и дъх",description:"Грижата за зъбите подпомага апетита, комфорта и дългосрочното благосъстояние.",button:"Ръководство за зъбите"},
fitness:{badge:"АКТИВНОСТ",title:"Движение и игра",description:"Упражненията, заниманията и играта помагат на животните да бъдат активни, щастливи и стимулирани.",button:"Активно пътуване"}
},
firstAid:{badge:"ПЪРВА ПОМОЩ",title:"Разпознаване на спешност",descriptionOne:"Всеки собственик трябва да знае основните тревожни признаци: проблеми с дишането, колапс, силно кървене, отравяне, повтарящо се повръщане, гърчове или внезапна невъзможност за ходене.",descriptionTwo:"При спешност не чакайте съвет от интернет. Незабавно се свържете с ветеринар, ветеринарна клиника за спешна помощ или токсикологична линия за животни.",button:"Намери помощ наблизо"},
checklist:{title:"Списък за здраве и грижа",one:"Поддържайте информацията за ваксини и микрочип актуална.",two:"Правете редовни ветеринарни и стоматологични прегледи.",three:"Следете апетита, пиенето, поведението, дишането и енергията.",four:"Използвайте безопасни процедури за грижа за кожата и козината.",five:"Запазете в телефона контактите на ветеринарна клиника за спешна помощ.",six:"Подгответе малка аптечка за първа помощ за дома и пътуване.",seven:"Питайте специалист преди използване на добавки, лекарства или природни средства."},
emergency:{title:"Кога да потърсите спешна помощ",description:"Потърсете незабавна ветеринарна помощ при затруднено дишане, подозрение за отравяне, колапс, силна болка, кървене, гърчове, топлинен удар, травма, подут корем, повтарящо се повръщане или друга внезапна сериозна промяна.",button:"Намери ветеринари наблизо"},
club:{title:"Предимства за членовете на клуба",description:"Клубът PETS & DOGUE ще свърже членовете с партньори в областта на здравето и грижата, предложения за поддържане на козината, ръководства за грижа, спа услуги за животни и подбрани премиум препоръки.",grooming:"Отстъпки за грижа за козината",spa:"Спа предложения за животни",guides:"Ръководства за здраве и грижа",nutrition:"Партньори за хранене",vet:"Ветеринарни предимства",qr:"QR карта за член",button:"Присъедини се към клуба"},
footer:{home:"Начало",articles:"Статии",places:"Места",partners:"Партньори",club:"Клуб",privacy:"Поверителност",contact:"Контакт"},
images:{hero:"Здраве и грижа за животните",veterinary:"Ветеринарен преглед",nutrition:"Хранене на животните",behaviour:"Поведение на животното",grooming:"Грижа за козината",dental:"Грижа за зъбите",fitness:"Активност на животното",firstAid:"Първа помощ"}
},

el:{
meta:{title:"Υγεία και φροντίδα | PETS & DOGUE",description:"Υγεία κατοικιδίων, διατροφή, περιποίηση, συμπεριφορά, πρώτες βοήθειες, κτηνιατρική ενημέρωση και καθημερινή φροντίδα από το PETS & DOGUE."},
hero:{title:"Υγεία και φροντίδα",description:"Ένα premium κέντρο για την υγεία, τη διατροφή, την περιποίηση, τη συμπεριφορά, τις πρώτες βοήθειες και την καθημερινή φροντίδα των κατοικιδίων."},
page:{title:"Κέντρο Υγείας και Φροντίδας PETS & DOGUE"},
notice:{title:"Σημείωση υγείας της σύνταξης",description:"Η ενότητα υγείας και φροντίδας του PETS & DOGUE παρέχει μόνο γενικές πληροφορίες. Δεν αντικαθιστά την κτηνιατρική συμβουλή. Για κάθε ιατρικό ζήτημα επικοινωνείτε πάντα με εξειδικευμένο κτηνίατρο."},
cards:{
vet:{badge:"ΚΤΗΝΙΑΤΡΙΚΗ",title:"Κτηνιατρικοί έλεγχοι",description:"Οι τακτικοί έλεγχοι βοηθούν στον έγκαιρο εντοπισμό αλλαγών στην υγεία και στη διατήρηση της άνεσης του κατοικιδίου.",button:"Βρείτε κτηνιάτρους"},
nutrition:{badge:"ΔΙΑΤΡΟΦΗ",title:"Διατροφή και ισορροπία",description:"Η σωστή διατροφή, η ενυδάτωση και οι καθημερινές συνήθειες σίτισης αποτελούν τη βάση της ευεξίας.",button:"Διαβάστε οδηγούς"},
behaviour:{badge:"ΣΥΜΠΕΡΙΦΟΡΑ",title:"Ήρεμη ζωή",description:"Η ρουτίνα, η ήπια προσοχή και οι ασφαλείς χώροι βοηθούν τα ζώα να αισθάνονται σίγουρα και ασφαλή.",button:"Ρωτήστε την κοινότητα"},
grooming:{badge:"ΠΕΡΙΠΟΙΗΣΗ",title:"Τρίχωμα και ομορφιά",description:"Η περιποίηση δεν αφορά μόνο την εμφάνιση. Υποστηρίζει την άνεση, την υγεία του δέρματος και την καλή κατάσταση.",button:"Προσφορές συνεργατών"},
dental:{badge:"ΟΔΟΝΤΙΚΗ ΦΡΟΝΤΙΔΑ",title:"Δόντια και αναπνοή",description:"Η οδοντική φροντίδα υποστηρίζει την όρεξη, την άνεση και τη μακροχρόνια υγεία.",button:"Οδηγός οδοντικής φροντίδας"},
fitness:{badge:"ΔΡΑΣΤΗΡΙΟΤΗΤΑ",title:"Κίνηση και παιχνίδι",description:"Η άσκηση, οι δραστηριότητες εμπλουτισμού και το παιχνίδι βοηθούν τα ζώα να παραμένουν δραστήρια, χαρούμενα και πνευματικά ενεργά.",button:"Ενεργά ταξίδια"}
},
firstAid:{badge:"ΠΡΩΤΕΣ ΒΟΗΘΕΙΕΣ",title:"Αναγνώριση επείγοντος περιστατικού",descriptionOne:"Κάθε ιδιοκτήτης πρέπει να γνωρίζει βασικά προειδοποιητικά σημάδια: δυσκολία στην αναπνοή, κατάρρευση, σοβαρή αιμορραγία, δηλητηρίαση, επαναλαμβανόμενο εμετό, σπασμούς ή ξαφνική αδυναμία βάδισης.",descriptionTwo:"Σε επείγον περιστατικό μην περιμένετε συμβουλές από το διαδίκτυο. Επικοινωνήστε αμέσως με κτηνίατρο, κτηνιατρική κλινική επειγόντων περιστατικών ή γραμμή δηλητηριάσεων ζώων.",button:"Βρείτε βοήθεια κοντά σας"},
checklist:{title:"Λίστα ελέγχου υγείας και φροντίδας",one:"Διατηρείτε ενημερωμένα τα στοιχεία εμβολιασμού και μικροτσίπ.",two:"Προγραμματίζετε τακτικούς κτηνιατρικούς και οδοντιατρικούς ελέγχους.",three:"Παρακολουθείτε την όρεξη, την κατανάλωση νερού, τη συμπεριφορά, την αναπνοή και την ενέργεια.",four:"Ακολουθείτε ασφαλείς διαδικασίες περιποίησης του δέρματος και του τριχώματος.",five:"Αποθηκεύστε στο τηλέφωνό σας τα στοιχεία κτηνιατρικής κλινικής επειγόντων περιστατικών.",six:"Ετοιμάστε ένα μικρό κουτί πρώτων βοηθειών για το σπίτι και τα ταξίδια.",seven:"Συμβουλευτείτε επαγγελματία πριν χρησιμοποιήσετε συμπληρώματα, φάρμακα ή φυσικές θεραπείες."},
emergency:{title:"Πότε χρειάζεται επείγουσα βοήθεια",description:"Ζητήστε άμεσα κτηνιατρική βοήθεια σε περίπτωση δυσκολίας στην αναπνοή, πιθανής δηλητηρίασης, κατάρρευσης, έντονου πόνου, αιμορραγίας, σπασμών, θερμοπληξίας, τραυματισμού, πρησμένης κοιλιάς, επαναλαμβανόμενου εμετού ή οποιασδήποτε ξαφνικής σοβαρής αλλαγής.",button:"Βρείτε κτηνιάτρους κοντά σας"},
club:{title:"Προνόμια για τα μέλη της λέσχης",description:"Η Λέσχη PETS & DOGUE θα συνδέει τα μέλη με συνεργάτες υγείας και φροντίδας, προσφορές περιποίησης, οδηγούς φροντίδας, προνόμια σπα για κατοικίδια και επιλεγμένες premium προτάσεις.",grooming:"Εκπτώσεις περιποίησης",spa:"Προσφορές σπα για κατοικίδια",guides:"Οδηγοί υγείας και φροντίδας",nutrition:"Συνεργάτες διατροφής",vet:"Κτηνιατρικά προνόμια",qr:"Κάρτα QR μέλους",button:"Εγγραφή στη λέσχη"},
footer:{home:"Αρχική",articles:"Άρθρα",places:"Μέρη",partners:"Συνεργάτες",club:"Λέσχη",privacy:"Απόρρητο",contact:"Επικοινωνία"},
images:{hero:"Υγεία και φροντίδα κατοικιδίων",veterinary:"Κτηνιατρικός έλεγχος",nutrition:"Διατροφή κατοικιδίου",behaviour:"Συμπεριφορά κατοικιδίου",grooming:"Περιποίηση κατοικιδίου",dental:"Οδοντική φροντίδα",fitness:"Σωματική δραστηριότητα κατοικιδίου",firstAid:"Πρώτες βοήθειες"}
},

sv:{
meta:{title:"Hälsa och omsorg | PETS & DOGUE",description:"Djurhälsa, kost, pälsvård, beteende, första hjälpen, veterinär information och vardaglig vård från PETS & DOGUE."},
hero:{title:"Hälsa och omsorg",description:"Ett premiumcenter för djurhälsa, kost, pälsvård, beteende, första hjälpen och vardaglig vård."},
page:{title:"PETS & DOGUE Centrum för Hälsa och Omsorg"},
notice:{title:"Redaktionell hälsonotis",description:"PETS & DOGUEs avdelning för hälsa och omsorg ger endast allmän information. Den ersätter inte veterinär rådgivning. Vid medicinska problem ska du alltid kontakta en kvalificerad veterinär."},
cards:{
vet:{badge:"VETERINÄR",title:"Veterinärkontroller",description:"Regelbundna kontroller hjälper till att upptäcka hälsoförändringar tidigt och hålla ditt djur bekvämt.",button:"Hitta veterinärer"},
nutrition:{badge:"NÄRING",title:"Mat och balans",description:"Näring, vätska och dagliga matvanor är grunden för djurets välbefinnande.",button:"Läs guider"},
behaviour:{badge:"BETEENDE",title:"Ett lugnt liv",description:"Rutiner, varsam uppmärksamhet och trygga platser hjälper djur att känna sig säkra och självsäkra.",button:"Fråga gemenskapen"},
grooming:{badge:"PÄLSVÅRD",title:"Päls och skönhet",description:"Pälsvård handlar inte bara om stil. Det stödjer komfort, hudhälsa och välbefinnande.",button:"Partnererbjudanden"},
dental:{badge:"TANDVÅRD",title:"Tänder och andedräkt",description:"Tandvård stödjer aptit, komfort och långsiktigt välbefinnande.",button:"Tandvårdsguide"},
fitness:{badge:"AKTIVITET",title:"Rörelse och lek",description:"Motion, berikande aktiviteter och lek hjälper djur att förbli aktiva, glada och mentalt stimulerade.",button:"Aktiva resor"}
},
firstAid:{badge:"FÖRSTA HJÄLPEN",title:"Känn igen en nödsituation",descriptionOne:"Varje djurägare bör känna till viktiga varningssignaler: andningsproblem, kollaps, kraftig blödning, förgiftning, upprepade kräkningar, kramper eller plötslig oförmåga att gå.",descriptionTwo:"Vid en nödsituation, vänta inte på råd online. Kontakta genast en veterinär, akutmottagning eller giftlinje för djur.",button:"Hitta lokal hjälp"},
checklist:{title:"Checklista för hälsa och omsorg",one:"Håll vaccinations- och mikrochipuppgifter uppdaterade.",two:"Boka regelbundna veterinär- och tandkontroller.",three:"Följ aptit, drickande, beteende, andning och energi.",four:"Använd säkra rutiner för hud- och pälsvård.",five:"Spara kontaktuppgifter till en veterinär akutmottagning i telefonen.",six:"Förbered ett litet första hjälpen-kit för hem och resa.",seven:"Fråga professionella innan du använder kosttillskott, läkemedel eller naturmedel."},
emergency:{title:"När du ska söka akut hjälp",description:"Sök akut veterinärhjälp vid andningssvårigheter, misstänkt förgiftning, kollaps, svår smärta, blödning, kramper, värmeslag, trauma, svullen buk, upprepade kräkningar eller annan plötslig allvarlig förändring.",button:"Hitta veterinärer nära dig"},
club:{title:"Förmåner för klubbmedlemmar",description:"PETS & DOGUE-klubben kopplar samman medlemmar med partners inom hälsa och omsorg, pälsvårdserbjudanden, vårdguider, djurspa-förmåner och utvalda premiumrekommendationer.",grooming:"Pälsvårdsrabatter",spa:"Djurspa-erbjudanden",guides:"Guider för hälsa och omsorg",nutrition:"Näringspartners",vet:"Veterinärförmåner",qr:"Medlems-QR-kort",button:"Gå med i klubben"},
footer:{home:"Hem",articles:"Artiklar",places:"Platser",partners:"Partners",club:"Klubb",privacy:"Integritet",contact:"Kontakt"},
images:{hero:"Djurhälsa och omsorg",veterinary:"Veterinärkontroll",nutrition:"Djurnäring",behaviour:"Djurbeteende",grooming:"Pälsvård",dental:"Tandvård",fitness:"Djuraktivitet",firstAid:"Första hjälpen"}
},

da:{
meta:{title:"Sundhed og pleje | PETS & DOGUE",description:"Kæledyrssundhed, ernæring, pelspleje, adfærd, førstehjælp, veterinær information og daglig pleje fra PETS & DOGUE."},
hero:{title:"Sundhed og pleje",description:"Et premiumcenter for kæledyrssundhed, ernæring, pelspleje, adfærd, førstehjælp og daglig pleje."},
page:{title:"PETS & DOGUE Center for Sundhed og Pleje"},
notice:{title:"Redaktionel sundhedsnote",description:"PETS & DOGUEs afdeling for sundhed og pleje giver kun generel information. Den erstatter ikke veterinær rådgivning. Ved medicinske bekymringer skal du altid kontakte en kvalificeret dyrlæge."},
cards:{
vet:{badge:"DYRLÆGE",title:"Dyrlægekontroller",description:"Regelmæssige kontroller hjælper med tidligt at opdage helbredsændringer og holde dit kæledyr komfortabelt.",button:"Find dyrlæger"},
nutrition:{badge:"ERNÆRING",title:"Mad og balance",description:"Ernæring, væske og daglige fodringsvaner er grundlaget for kæledyrets velvære.",button:"Læs guider"},
behaviour:{badge:"ADFÆRD",title:"Roligt liv",description:"Rutine, blid opmærksomhed og sikre områder hjælper kæledyr med at føle sig trygge og sikre.",button:"Spørg fællesskabet"},
grooming:{badge:"PELSLEJE",title:"Pels og skønhed",description:"Pelspleje handler ikke kun om stil. Det støtter komfort, hudens sundhed og velvære.",button:"Partnertilbud"},
dental:{badge:"TANDPLEJE",title:"Tænder og ånde",description:"Tandpleje støtter appetit, komfort og langsigtet velvære.",button:"Tandguide"},
fitness:{badge:"AKTIVITET",title:"Bevægelse og leg",description:"Motion, stimulerende aktiviteter og leg hjælper kæledyr med at forblive aktive, glade og mentalt stimulerede.",button:"Aktive rejser"}
},
firstAid:{badge:"FØRSTEHJÆLP",title:"Genkend en nødsituation",descriptionOne:"Enhver ejer bør kende de vigtigste advarselstegn: vejrtrækningsproblemer, kollaps, kraftig blødning, forgiftning, gentagen opkastning, kramper eller pludselig manglende evne til at gå.",descriptionTwo:"Ved en nødsituation skal du ikke vente på online råd. Kontakt straks en dyrlæge, akutklinik eller giftlinje for dyr.",button:"Find lokal hjælp"},
checklist:{title:"Tjekliste for sundhed og pleje",one:"Hold vaccination og mikrochipoplysninger opdaterede.",two:"Book regelmæssige dyrlæge- og tandkontroller.",three:"Hold øje med appetit, væskeindtag, adfærd, vejrtrækning og energi.",four:"Brug sikre rutiner til hud- og pelspleje.",five:"Gem kontaktoplysninger til en veterinær akutklinik på telefonen.",six:"Forbered et lille førstehjælpskit til hjemmet og rejser.",seven:"Spørg fagfolk før brug af kosttilskud, medicin eller naturmidler."},
emergency:{title:"Hvornår du skal søge akut hjælp",description:"Søg akut dyrlægehjælp ved vejrtrækningsbesvær, mistænkt forgiftning, kollaps, stærke smerter, blødning, kramper, hedeslag, traume, hævet mave, gentagen opkastning eller enhver pludselig alvorlig ændring.",button:"Find dyrlæger i nærheden"},
club:{title:"Fordele for klubmedlemmer",description:"PETS & DOGUE-klubben forbinder medlemmer med partnere inden for sundhed og pleje, pelsplejetilbud, plejeguider, dyrespa-fordele og udvalgte premiumanbefalinger.",grooming:"Pelsplejerabatter",spa:"Dyrespa-tilbud",guides:"Guider til sundhed og pleje",nutrition:"Ernæringspartnere",vet:"Dyrlægefordele",qr:"Medlems-QR-kort",button:"Bliv medlem af klubben"},
footer:{home:"Forside",articles:"Artikler",places:"Steder",partners:"Partnere",club:"Klub",privacy:"Privatliv",contact:"Kontakt"},
images:{hero:"Kæledyrssundhed og pleje",veterinary:"Dyrlægekontrol",nutrition:"Kæledyrsernæring",behaviour:"Kæledyrsadfærd",grooming:"Pelspleje",dental:"Tandpleje",fitness:"Kæledyrsaktivitet",firstAid:"Førstehjælp"}
},

no:{
meta:{title:"Helse og omsorg | PETS & DOGUE",description:"Kjæledyrhelse, ernæring, pelsstell, atferd, førstehjelp, veterinær informasjon og daglig omsorg fra PETS & DOGUE."},
hero:{title:"Helse og omsorg",description:"Et premium senter for kjæledyrhelse, ernæring, pelsstell, atferd, førstehjelp og daglig omsorg."},
page:{title:"PETS & DOGUE Senter for Helse og Omsorg"},
notice:{title:"Redaksjonell helsenotis",description:"PETS & DOGUEs seksjon for helse og omsorg gir kun generell informasjon. Den erstatter ikke veterinærråd. Ved medisinske bekymringer skal du alltid kontakte en kvalifisert veterinær."},
cards:{
vet:{badge:"VETERINÆR",title:"Veterinærkontroller",description:"Regelmessige kontroller hjelper med å oppdage helseendringer tidlig og holde kjæledyret komfortabelt.",button:"Finn veterinærer"},
nutrition:{badge:"ERNÆRING",title:"Mat og balanse",description:"Ernæring, væske og daglige fôringsvaner er grunnlaget for kjæledyrets velvære.",button:"Les guider"},
behaviour:{badge:"ATFERD",title:"Rolig liv",description:"Rutiner, mild oppmerksomhet og trygge områder hjelper kjæledyr å føle seg sikre og selvsikre.",button:"Spør fellesskapet"},
grooming:{badge:"PELSSTELL",title:"Pels og skjønnhet",description:"Pelsstell handler ikke bare om stil. Det støtter komfort, hudhelse og velvære.",button:"Partnertilbud"},
dental:{badge:"TANNPLEIE",title:"Tenner og ånde",description:"Tannpleie støtter appetitt, komfort og langsiktig velvære.",button:"Tannguide"},
fitness:{badge:"AKTIVITET",title:"Bevegelse og lek",description:"Mosjon, berikende aktiviteter og lek hjelper kjæledyr å holde seg aktive, glade og mentalt stimulert.",button:"Aktive reiser"}
},
firstAid:{badge:"FØRSTEHJELP",title:"Gjenkjenn en nødsituasjon",descriptionOne:"Alle eiere bør kjenne viktige varselsignaler: pustevansker, kollaps, kraftig blødning, forgiftning, gjentatt oppkast, anfall eller plutselig manglende evne til å gå.",descriptionTwo:"Ved en nødsituasjon bør du ikke vente på råd online. Kontakt veterinær, akuttklinikk eller giftlinje for dyr umiddelbart.",button:"Finn lokal hjelp"},
checklist:{title:"Sjekkliste for helse og omsorg",one:"Hold vaksinasjons- og mikrochipinformasjon oppdatert.",two:"Bestill regelmessige veterinær- og tannkontroller.",three:"Følg med på appetitt, drikking, atferd, pust og energi.",four:"Bruk trygge rutiner for hud- og pelspleie.",five:"Lagre kontaktinformasjon til en veterinær akuttklinikk på telefonen.",six:"Forbered et lite førstehjelpssett for hjem og reise.",seven:"Spør fagfolk før du bruker kosttilskudd, medisiner eller naturmidler."},
emergency:{title:"Når du bør søke akutt hjelp",description:"Søk akutt veterinærhjelp ved pustevansker, mistanke om forgiftning, kollaps, sterke smerter, blødning, anfall, heteslag, traume, oppblåst mage, gjentatt oppkast eller enhver plutselig alvorlig endring.",button:"Finn veterinærer i nærheten"},
club:{title:"Fordeler for klubbmedlemmer",description:"PETS & DOGUE-klubben kobler medlemmer til partnere innen helse og omsorg, pelsstelltilbud, pleieguider, dyrespa-fordeler og utvalgte premiumanbefalinger.",grooming:"Pelsstellrabatter",spa:"Dyrespa-tilbud",guides:"Guider for helse og omsorg",nutrition:"Ernæringspartnere",vet:"Veterinærfordeler",qr:"Medlems-QR-kort",button:"Bli med i klubben"},
footer:{home:"Hjem",articles:"Artikler",places:"Steder",partners:"Partnere",club:"Klubb",privacy:"Personvern",contact:"Kontakt"},
images:{hero:"Kjæledyrhelse og omsorg",veterinary:"Veterinærkontroll",nutrition:"Kjæledyrernæring",behaviour:"Kjæledyratferd",grooming:"Pelsstell",dental:"Tannpleie",fitness:"Kjæledyraktivitet",firstAid:"Førstehjelp"}
},

fi:{
meta:{title:"Terveys ja hoito | PETS & DOGUE",description:"Lemmikkien terveys, ravitsemus, turkinhoito, käyttäytyminen, ensiapu, eläinlääkäritieto ja päivittäinen hoito PETS & DOGUE:lta."},
hero:{title:"Terveys ja hoito",description:"Premium-keskus lemmikkien terveydelle, ravitsemukselle, turkinhoidolle, käyttäytymiselle, ensiavulle ja päivittäiselle hoidolle."},
page:{title:"PETS & DOGUE Terveys- ja Hoitokeskus"},
notice:{title:"Toimituksen terveyshuomautus",description:"PETS & DOGUEn terveys- ja hoito-osio tarjoaa vain yleistä tietoa. Se ei korvaa eläinlääkärin neuvoja. Lääketieteellisissä huolissa ota aina yhteyttä pätevään eläinlääkäriin."},
cards:{
vet:{badge:"ELÄINLÄÄKÄRI",title:"Eläinlääkärintarkastukset",description:"Säännölliset tarkastukset auttavat huomaamaan terveysmuutokset varhain ja pitämään lemmikin hyvässä kunnossa.",button:"Etsi eläinlääkäreitä"},
nutrition:{badge:"RAVITSEMUS",title:"Ruoka ja tasapaino",description:"Ravitsemus, nesteytys ja päivittäiset ruokintatavat ovat lemmikin hyvinvoinnin perusta.",button:"Lue oppaita"},
behaviour:{badge:"KÄYTTÄYTYMINEN",title:"Rauhallinen elämä",description:"Rutiinit, lempeä huomio ja turvalliset tilat auttavat lemmikkejä tuntemaan olonsa varmaksi ja turvalliseksi.",button:"Kysy yhteisöltä"},
grooming:{badge:"TURKINHOITO",title:"Turkki ja kauneus",description:"Turkinhoito ei ole vain tyyliä. Se tukee mukavuutta, ihon terveyttä ja hyvinvointia.",button:"Kumppanitarjoukset"},
dental:{badge:"HAMMASHOITO",title:"Hampaat ja hengitys",description:"Hammashoito tukee ruokahalua, mukavuutta ja pitkäaikaista hyvinvointia.",button:"Hammasopas"},
fitness:{badge:"AKTIIVISUUS",title:"Liike ja leikki",description:"Liikunta, virikkeet ja leikki auttavat lemmikkejä pysymään aktiivisina, onnellisina ja henkisesti virkeinä.",button:"Aktiivinen matkailu"}
},
firstAid:{badge:"ENSIAPU",title:"Hätätilanteen tunnistaminen",descriptionOne:"Jokaisen omistajan tulisi tuntea tärkeät varoitusmerkit: hengitysvaikeus, romahtaminen, voimakas verenvuoto, myrkytys, toistuva oksentelu, kohtaukset tai äkillinen kävelykyvyttömyys.",descriptionTwo:"Hätätilanteessa älä odota verkkoneuvoja. Ota heti yhteyttä eläinlääkäriin, päivystysklinikkaan tai eläinmyrkytysten neuvontaan.",button:"Etsi paikallista apua"},
checklist:{title:"Terveyden ja hoidon tarkistuslista",one:"Pidä rokotus- ja mikrosirutiedot ajan tasalla.",two:"Varaa säännölliset eläinlääkärin ja hammashoidon tarkastukset.",three:"Seuraa ruokahalua, juomista, käyttäytymistä, hengitystä ja energiaa.",four:"Käytä turvallisia iho- ja turkinhoitorutiineja.",five:"Tallenna päivystävän eläinklinikan yhteystiedot puhelimeesi.",six:"Valmistele pieni ensiapupakkaus kotiin ja matkalle.",seven:"Kysy ammattilaiselta ennen lisäravinteiden, lääkkeiden tai luonnonhoitojen käyttöä."},
emergency:{title:"Milloin hakea kiireellistä apua",description:"Hakeudu kiireellisesti eläinlääkäriin hengitysvaikeuksien, epäillyn myrkytyksen, romahtamisen, voimakkaan kivun, verenvuodon, kohtausten, lämpöhalvauksen, trauman, turvonneen vatsan, toistuvan oksentelun tai muun äkillisen vakavan muutoksen vuoksi.",button:"Etsi eläinlääkäreitä läheltä"},
club:{title:"Edut klubin jäsenille",description:"PETS & DOGUE -Klubi yhdistää jäsenet terveys- ja hoitokumppaneihin, turkinhoitotarjouksiin, hoito-oppaisiin, lemmikkikylpyläetuihin ja valikoituihin premium-suosituksiin.",grooming:"Turkinhoitoalennukset",spa:"Lemmikkikylpylätarjoukset",guides:"Terveys- ja hoito-oppaat",nutrition:"Ravitsemuskumppanit",vet:"Eläinlääkärikumppanien edut",qr:"Jäsenen QR-kortti",button:"Liity Klubiin"},
footer:{home:"Etusivu",articles:"Artikkelit",places:"Paikat",partners:"Kumppanit",club:"Klubi",privacy:"Tietosuoja",contact:"Yhteystiedot"},
images:{hero:"Lemmikin terveys ja hoito",veterinary:"Eläinlääkärintarkastus",nutrition:"Lemmikin ravitsemus",behaviour:"Lemmikin käyttäytyminen",grooming:"Turkinhoito",dental:"Hammashoito",fitness:"Lemmikin aktiivisuus",firstAid:"Ensiapu"}
},

tr:{
meta:{title:"Sağlık ve Bakım | PETS & DOGUE",description:"PETS & DOGUE ile evcil hayvan sağlığı, beslenme, bakım, davranış, ilk yardım, veteriner bilgilendirmesi ve günlük bakım."},
hero:{title:"Sağlık ve Bakım",description:"Evcil hayvan sağlığı, beslenme, bakım, davranış, ilk yardım ve günlük bakım için premium merkez."},
page:{title:"PETS & DOGUE Sağlık ve Bakım Merkezi"},
notice:{title:"Editoryal Sağlık Notu",description:"PETS & DOGUE Sağlık ve Bakım bölümü yalnızca genel bakım ve yaşam bilgileri sunar. Veteriner tavsiyesinin yerini tutmaz. Tıbbi bir endişeniz olduğunda her zaman yetkin bir veterinerle iletişime geçin."},
cards:{
vet:{badge:"VETERİNER",title:"Veteriner Kontrolleri",description:"Düzenli kontroller sağlık değişikliklerini erken fark etmeye ve evcil hayvanınızın rahatlığını korumaya yardımcı olur.",button:"Veteriner Bul"},
nutrition:{badge:"BESLENME",title:"Beslenme ve Denge",description:"Doğru beslenme, yeterli su tüketimi ve günlük beslenme alışkanlıkları evcil hayvan sağlığının temelidir.",button:"Rehberleri Oku"},
behaviour:{badge:"DAVRANIŞ",title:"Sakin Yaşam",description:"Rutin, nazik ilgi ve güvenli alanlar evcil hayvanların kendilerini güvende ve rahat hissetmelerine yardımcı olur.",button:"Topluluğa Sor"},
grooming:{badge:"BAKIM",title:"Tüy ve Güzellik",description:"Bakım yalnızca görünümle ilgili değildir. Rahatlığı, cilt sağlığını ve evcil hayvanın iyi hissetmesini destekler.",button:"Ortak Teklifleri"},
dental:{badge:"DİŞ BAKIMI",title:"Dişler ve Nefes",description:"Diş bakımı iştahı, rahatlığı ve uzun vadeli sağlığı destekler.",button:"Diş Bakımı Rehberi"},
fitness:{badge:"AKTİVİTE",title:"Hareket ve Oyun",description:"Egzersiz, zihinsel etkinlikler ve oyun evcil hayvanların aktif, mutlu ve zihinsel olarak canlı kalmasına yardımcı olur.",button:"Aktif Seyahat"}
},
firstAid:{badge:"İLK YARDIM",title:"Acil Durumu Tanıma",descriptionOne:"Her hayvan sahibi temel uyarı işaretlerini bilmelidir: solunum sorunu, bayılma veya çökme, ciddi kanama, zehirlenme, tekrarlayan kusma, nöbet ya da aniden yürüyememe.",descriptionTwo:"Acil durumda internetten tavsiye beklemeyin. Hemen bir veterinerle, acil veteriner kliniğiyle veya hayvan zehir danışma hattıyla iletişime geçin.",button:"Yakındaki Yardımı Bul"},
checklist:{title:"Sağlık ve Bakım Kontrol Listesi",one:"Aşı ve mikroçip bilgilerini güncel tutun.",two:"Düzenli veteriner ve diş kontrolleri yaptırın.",three:"İştahı, su tüketimini, davranışı, solunumu ve enerji düzeyini takip edin.",four:"Güvenli tüy, cilt ve genel bakım rutinleri uygulayın.",five:"Acil veteriner kliniğinin iletişim bilgilerini telefonunuza kaydedin.",six:"Ev ve seyahat için küçük bir ilk yardım çantası hazırlayın.",seven:"Takviye, ilaç veya doğal ürün kullanmadan önce bir uzmana danışın."},
emergency:{title:"Ne Zaman Acil Yardım Alınmalı",description:"Solunum güçlüğü, zehirlenme şüphesi, bayılma veya çökme, şiddetli ağrı, kanama, nöbet, sıcak çarpması, travma, karın şişliği, tekrarlayan kusma veya ani ciddi bir değişiklikte acil veteriner yardımı alın.",button:"Yakındaki Veterinerleri Ara"},
club:{title:"Kulüp Üyeleri İçin Sağlık ve Bakım Avantajları",description:"PETS & DOGUE Kulübü, üyeleri sağlık ve bakım ortakları, bakım indirimleri, bakım rehberleri, evcil hayvan spa avantajları ve seçilmiş premium önerilerle buluşturacaktır.",grooming:"Bakım İndirimleri",spa:"Evcil Hayvan Spa Teklifleri",guides:"Sağlık ve Bakım Rehberleri",nutrition:"Beslenme Ortakları",vet:"Veteriner Ortak Avantajları",qr:"Üye QR Kartı",button:"Kulübe Katıl"},
footer:{home:"Ana Sayfa",articles:"Makaleler",places:"Mekânlar",partners:"Ortaklar",club:"Kulüp",privacy:"Gizlilik",contact:"İletişim"},
images:{hero:"Evcil hayvan sağlığı ve bakımı",veterinary:"Veteriner kontrolü",nutrition:"Evcil hayvan beslenmesi",behaviour:"Evcil hayvan davranışı",grooming:"Evcil hayvan bakımı",dental:"Diş bakımı",fitness:"Evcil hayvan aktivitesi",firstAid:"İlk yardım"}
},

ar:{
meta:{title:"الصحة والعناية | PETS & DOGUE",description:"صحة الحيوانات الأليفة والتغذية والعناية والسلوك والإسعافات الأولية والتوعية البيطرية والرعاية اليومية من PETS & DOGUE."},
hero:{title:"الصحة والعناية",description:"مركز فاخر لصحة الحيوانات الأليفة وتغذيتها والعناية بها وسلوكها والإسعافات الأولية والرعاية اليومية."},
page:{title:"مركز PETS & DOGUE للصحة والعناية"},
notice:{title:"ملاحظة صحية من هيئة التحرير",description:"يقدم قسم الصحة والعناية في PETS & DOGUE معلومات عامة عن الرعاية والحياة اليومية فقط. ولا يحل محل الاستشارة البيطرية. عند وجود أي مشكلة صحية، تواصل دائماً مع طبيب بيطري مؤهل."},
cards:{
vet:{badge:"الطب البيطري",title:"الفحوص البيطرية",description:"تساعد الفحوص المنتظمة على اكتشاف التغيرات الصحية مبكراً والحفاظ على راحة الحيوان.",button:"البحث عن أطباء بيطريين"},
nutrition:{badge:"التغذية",title:"الغذاء والتوازن",description:"التغذية المناسبة والترطيب وعادات الطعام اليومية هي أساس صحة الحيوان وراحته.",button:"قراءة الأدلة"},
behaviour:{badge:"السلوك",title:"حياة هادئة",description:"يساعد الروتين والاهتمام اللطيف والمساحات الآمنة الحيوانات على الشعور بالثقة والأمان.",button:"اسأل المجتمع"},
grooming:{badge:"العناية",title:"الفرو والجمال",description:"العناية ليست مجرد مظهر. فهي تدعم الراحة وصحة الجلد والشعور الجيد للحيوان.",button:"عروض الشركاء"},
dental:{badge:"العناية بالأسنان",title:"الأسنان ورائحة الفم",description:"تدعم العناية بالأسنان الشهية والراحة والصحة على المدى الطويل.",button:"دليل العناية بالأسنان"},
fitness:{badge:"النشاط",title:"الحركة واللعب",description:"تساعد التمارين والأنشطة الذهنية واللعب الحيوانات على البقاء نشطة وسعيدة ومحفزة ذهنياً.",button:"السفر النشط"}
},
firstAid:{badge:"الإسعافات الأولية",title:"التعرف على الحالة الطارئة",descriptionOne:"يجب أن يعرف كل مالك أهم علامات التحذير: صعوبة التنفس، الانهيار، النزيف الشديد، التسمم، القيء المتكرر، النوبات أو عدم القدرة المفاجئة على المشي.",descriptionTwo:"في حالة الطوارئ لا تنتظر نصيحة من الإنترنت. تواصل فوراً مع طبيب بيطري أو عيادة بيطرية للطوارئ أو خدمة متخصصة بحالات تسمم الحيوانات.",button:"العثور على مساعدة قريبة"},
checklist:{title:"قائمة الصحة والعناية",one:"حافظ على تحديث معلومات اللقاحات والرقاقة الإلكترونية.",two:"احجز فحوصاً بيطرية وفحوص أسنان منتظمة.",three:"راقب الشهية وشرب الماء والسلوك والتنفس ومستوى الطاقة.",four:"استخدم روتيناً آمناً للعناية بالجلد والفرو.",five:"احفظ بيانات عيادة بيطرية للطوارئ في هاتفك.",six:"جهز حقيبة إسعافات أولية صغيرة للمنزل والسفر.",seven:"استشر المختصين قبل استخدام المكملات أو الأدوية أو العلاجات الطبيعية."},
emergency:{title:"متى تحتاج إلى مساعدة عاجلة",description:"اطلب مساعدة بيطرية عاجلة عند صعوبة التنفس أو الاشتباه بالتسمم أو الانهيار أو الألم الشديد أو النزيف أو النوبات أو ضربة الحرارة أو الإصابة أو انتفاخ البطن أو القيء المتكرر أو أي تغير خطير مفاجئ.",button:"ابحث عن أطباء بيطريين قريبين"},
club:{title:"مزايا الصحة والعناية لأعضاء النادي",description:"سيربط نادي PETS & DOGUE الأعضاء بشركاء في مجال الصحة والعناية، وعروض العناية، وأدلة الرعاية، ومزايا منتجعات الحيوانات الأليفة، والتوصيات المميزة المختارة.",grooming:"خصومات العناية",spa:"عروض منتجعات الحيوانات",guides:"أدلة الصحة والعناية",nutrition:"شركاء التغذية",vet:"مزايا الشركاء البيطريين",qr:"بطاقة QR للعضو",button:"الانضمام إلى النادي"},
footer:{home:"الرئيسية",articles:"المقالات",places:"الأماكن",partners:"الشركاء",club:"النادي",privacy:"الخصوصية",contact:"اتصل بنا"},
images:{hero:"صحة الحيوانات الأليفة والعناية بها",veterinary:"فحص بيطري",nutrition:"تغذية الحيوانات",behaviour:"سلوك الحيوانات",grooming:"العناية بالحيوان",dental:"العناية بالأسنان",fitness:"نشاط الحيوان",firstAid:"الإسعافات الأولية"}
},

hi:{
meta:{title:"स्वास्थ्य और देखभाल | PETS & DOGUE",description:"PETS & DOGUE से पालतू जानवरों का स्वास्थ्य, पोषण, सौंदर्य देखभाल, व्यवहार, प्राथमिक उपचार, पशुचिकित्सा जागरूकता और दैनिक देखभाल।"},
hero:{title:"स्वास्थ्य और देखभाल",description:"पालतू जानवरों के स्वास्थ्य, पोषण, सौंदर्य देखभाल, व्यवहार, प्राथमिक उपचार और दैनिक देखभाल के लिए एक प्रीमियम केंद्र।"},
page:{title:"PETS & DOGUE स्वास्थ्य और देखभाल केंद्र"},
notice:{title:"संपादकीय स्वास्थ्य सूचना",description:"PETS & DOGUE का स्वास्थ्य और देखभाल अनुभाग केवल सामान्य देखभाल और जीवनशैली संबंधी जानकारी प्रदान करता है। यह पशुचिकित्सक की सलाह का विकल्प नहीं है। किसी भी चिकित्सकीय चिंता में हमेशा योग्य पशुचिकित्सक से संपर्क करें।"},
cards:{
vet:{badge:"पशुचिकित्सा",title:"पशुचिकित्सा जाँच",description:"नियमित जाँच स्वास्थ्य में होने वाले बदलावों को जल्दी पहचानने और आपके पालतू जानवर को सहज रखने में मदद करती है।",button:"पशुचिकित्सक खोजें"},
nutrition:{badge:"पोषण",title:"भोजन और संतुलन",description:"सही पोषण, पर्याप्त पानी और नियमित भोजन की आदतें पालतू जानवर के अच्छे स्वास्थ्य की नींव हैं।",button:"मार्गदर्शिकाएँ पढ़ें"},
behaviour:{badge:"व्यवहार",title:"शांत जीवन",description:"नियमित दिनचर्या, कोमल ध्यान और सुरक्षित जगहें पालतू जानवरों को आत्मविश्वासी और सुरक्षित महसूस करने में मदद करती हैं।",button:"समुदाय से पूछें"},
grooming:{badge:"सौंदर्य देखभाल",title:"रोएँ और सुंदरता",description:"सौंदर्य देखभाल केवल रूप-रंग के लिए नहीं है। यह आराम, त्वचा के स्वास्थ्य और अच्छे महसूस करने में मदद करती है।",button:"साझेदार प्रस्ताव"},
dental:{badge:"दाँतों की देखभाल",title:"दाँत और साँस",description:"दाँतों की उचित देखभाल भूख, आराम और लंबे समय के स्वास्थ्य में सहायता करती है।",button:"दाँतों की देखभाल मार्गदर्शिका"},
fitness:{badge:"गतिविधि",title:"गतिशीलता और खेल",description:"व्यायाम, मानसिक गतिविधियाँ और खेल पालतू जानवरों को सक्रिय, खुश और मानसिक रूप से सजग रखने में मदद करते हैं।",button:"सक्रिय यात्राएँ"}
},
firstAid:{badge:"प्राथमिक उपचार",title:"आपात स्थिति पहचानें",descriptionOne:"हर पालतू मालिक को मुख्य चेतावनी संकेत पता होने चाहिए: साँस लेने में परेशानी, अचानक गिरना, गंभीर रक्तस्राव, विषाक्तता, बार-बार उल्टी, दौरे या अचानक चल न पाना।",descriptionTwo:"आपात स्थिति में इंटरनेट की सलाह का इंतज़ार न करें। तुरंत पशुचिकित्सक, आपात पशुचिकित्सा क्लिनिक या पशु विष सहायता सेवा से संपर्क करें।",button:"पास में सहायता खोजें"},
checklist:{title:"स्वास्थ्य और देखभाल सूची",one:"टीकाकरण और माइक्रोचिप की जानकारी अद्यतन रखें।",two:"नियमित पशुचिकित्सा और दंत जाँच करवाएँ।",three:"भूख, पानी पीने की मात्रा, व्यवहार, साँस और ऊर्जा पर ध्यान दें।",four:"त्वचा और रोएँ की सुरक्षित देखभाल दिनचर्या अपनाएँ।",five:"आपात पशुचिकित्सा क्लिनिक की जानकारी अपने फोन में सुरक्षित रखें।",six:"घर और यात्रा के लिए छोटी प्राथमिक उपचार किट तैयार रखें।",seven:"पूरक, दवाइयाँ या प्राकृतिक उपचार देने से पहले विशेषज्ञ से सलाह लें।"},
emergency:{title:"तुरंत सहायता कब लें",description:"साँस लेने में कठिनाई, विषाक्तता का संदेह, अचानक गिरना, गंभीर दर्द, रक्तस्राव, दौरे, लू लगना, चोट, पेट फूलना, बार-बार उल्टी या किसी अचानक गंभीर बदलाव पर तुरंत पशुचिकित्सा सहायता लें।",button:"पास के पशुचिकित्सक खोजें"},
club:{title:"क्लब सदस्यों के लिए स्वास्थ्य और देखभाल लाभ",description:"PETS & DOGUE क्लब सदस्यों को स्वास्थ्य और देखभाल साझेदारों, सौंदर्य देखभाल प्रस्तावों, देखभाल मार्गदर्शिकाओं, पालतू स्पा लाभों और चुनिंदा प्रीमियम सुझावों से जोड़ेगा।",grooming:"सौंदर्य देखभाल छूट",spa:"पालतू स्पा प्रस्ताव",guides:"स्वास्थ्य और देखभाल मार्गदर्शिकाएँ",nutrition:"पोषण साझेदार",vet:"पशुचिकित्सा साझेदार लाभ",qr:"सदस्य QR कार्ड",button:"क्लब में शामिल हों"},
footer:{home:"मुख्य पृष्ठ",articles:"लेख",places:"स्थान",partners:"साझेदार",club:"क्लब",privacy:"गोपनीयता",contact:"संपर्क"},
images:{hero:"पालतू जानवरों का स्वास्थ्य और देखभाल",veterinary:"पशुचिकित्सा जाँच",nutrition:"पालतू जानवरों का पोषण",behaviour:"पालतू जानवरों का व्यवहार",grooming:"पालतू जानवरों की सौंदर्य देखभाल",dental:"दाँतों की देखभाल",fitness:"पालतू जानवरों की गतिविधि",firstAid:"प्राथमिक उपचार"}
}
