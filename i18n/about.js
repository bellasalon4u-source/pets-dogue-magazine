...
window.PetsDogueTranslations.about = {

  en: {
    meta: {
      title: "About — PETS & DOGUE",
      description:
        "Learn more about PETS & DOGUE, our story, mission and future."
    },
    nav: {
      home: "Home",
    ...
    hero: {
      title: "About PETS & DOGUE",
      description:
        "PETS & DOGUE is an international luxury animal magazine celebrating the beauty, personality, style and stories of animals around the world."
    },
    story: {
      title: "Our Story",
      p1:
    ...
    mission: {
      title: "Our Mission",
      description:
        "To create the world's most prestigious magazine dedicated to animals, bringing together pet lovers, photographers, artists, brands and animal enthusiasts from every corner of the globe."
    },
    contact: {
      title: "Contact",
      p1:
  ...
  uk: {
    meta: {
      title: "Про нас — PETS & DOGUE",
      description:
        "Дізнайтеся більше про PETS & DOGUE, нашу історію, місію та майбутнє."
    },
    nav: {
      home: "Головна",
    ...
    hero: {
      ...
      description:
        "PETS & DOGUE — міжнародний люксовий журнал про тварин, що відзначає красу, характер, стиль та історії тварин з усього світу."
    },
    story: {
      title: "Наша історія",
      p1:
    ...
    mission: {
      title: "Наша місія",
      description:
        "Створити найпрестижніший у світі журнал, присвячений тваринам, який об’єднує любителів тварин, фотографів, митців, бренди та ентузіастів з усього світу."
    },
    contact: {
      title: "Контакти",
      p1:
  ...
  ru: {
    meta: {
      title: "О нас — PETS & DOGUE",
      description:
        "Узнайте больше о PETS & DOGUE, нашей истории, миссии и будущем."
    },
    nav: {
      home: "Главная",
    ...
    hero: {
      title: "О PETS & DOGUE",
      description:
        "PETS & DOGUE — международный люксовый журнал о животных, посвящённый красоте, характеру, стилю и историям животных со всего мира."
    },
    story: {
      title: "Наша история",
      p1:
    ...
    mission: {
      title: "Наша миссия",
      description:
        "Создать самый престижный в мире журнал, посвящённый животным, объединяя любителей животных, фотографов, художников, бренды и энтузиастов со всего мира."
    },
    contact: {
      title: "Контакты",
      p1:
  ...
  fr: {
    meta: {
      title: "À propos — PETS & DOGUE",
      description:
        "Découvrez PETS & DOGUE, notre histoire, notre mission et notre avenir."
    },
    nav: {
      home: "Accueil",
    ...
    hero: {
      ...
      description:
        "PETS & DOGUE est un magazine animalier international de luxe qui célèbre la beauté, la personnalité, le style et les histoires des animaux du monde entier."
    },
    story: {
    ...
    mission: {
      title: "Notre mission",
      description:
        "Créer le magazine consacré aux animaux le plus prestigieux au monde, réunissant amoureux des animaux, photographes, artistes, marques et passionnés venus des quatre coins du globe."
    },
    contact: {
      title: "Contact",
      p1:
  ...
  de: {
    meta: {
      title: "Über uns — PETS & DOGUE",
      description:
        "Erfahren Sie mehr über PETS & DOGUE, unsere Geschichte, Mission und Zukunft."
    },
    nav: {
      home: "Startseite",
    ...
    hero: {
      ...
      description:
        "PETS & DOGUE ist ein internationales Luxus-Tiermagazin, das die Schönheit, Persönlichkeit, den Stil und die Geschichten von Tieren aus aller Welt feiert."
    },
    story: {
    ...
    mission: {
      ...
      description:
        "Das weltweit prestigeträchtigste Magazin für Tiere zu schaffen und Tierliebhaber, Fotografen, Künstler, Marken und Tierbegeisterte aus aller Welt zusammenzubringen."
    },
    contact: {
      title: "Kontakt",
      p1:
  ...
  es: {
    meta: {
      ...
      description:
        "Conoce más sobre PETS & DOGUE, nuestra historia, misión y futuro."
    },
    nav: {
      home: "Inicio",
    ...
    hero: {
      title: "Acerca de PETS & DOGUE",
      description:
        "PETS & DOGUE es una revista internacional de lujo dedicada a los animales que celebra su belleza, personalidad, estilo e historias de todo el mundo."
    },
    story: {
    ...
    mission: {
      ...
      description:
        "Crear la revista dedicada a los animales más prestigiosa del mundo, reuniendo a amantes de los animales, fotógrafos, artistas, marcas y entusiastas de todos los rincones del planeta."
    },
    contact: {
      title: "Contacto",
      p1:
  ...
  it: {
    meta: {
      ...
      description:
        "Scopri di più su PETS & DOGUE, la nostra storia, missione e futuro."
    },
    nav: {
      home: "Home",
    ...
    hero: {
      title: "Chi siamo — PETS & DOGUE",
      description:
        "PETS & DOGUE è una rivista internazionale luxury dedicata agli animali, che celebra la loro bellezza, personalità, stile e le loro storie da tutto il mondo."
    },
    story: {
    ...
    mission: {
      ...
      description:
        "Creare la rivista dedicata agli animali più prestigiosa al mondo, riunendo amanti degli animali, fotografi, artisti, brand e appassionati da ogni parte del pianeta."
    },
    contact: {
      title: "Contatti",
      p1:
  ...
  pt: {
    meta: {
      ...
      description:
        "Saiba mais sobre PETS & DOGUE, a nossa história, missão e futuro."
    },
    nav: {
      home: "Início",
    ...
    hero: {
      title: "Sobre PETS & DOGUE",
      description:
        "PETS & DOGUE é uma revista internacional de luxo dedicada aos animais, celebrando a sua beleza, personalidade, estilo e histórias de todo o mundo."
    },
    story: {
    ...
    mission: {
      ...
      description:
        "Criar a revista dedicada aos animais mais prestigiada do mundo, reunindo amantes dos animais, fotógrafos, artistas, marcas e entusiastas de todos os cantos do planeta."
    },
    contact: {
      title: "Contacto",
      p1:
  ...
  nl: {
    meta: {
      title: "Over ons — PETS & DOGUE",
      description:
        "Lees meer over PETS & DOGUE, ons verhaal, onze missie en onze toekomst."
    },
    nav: {
      home: "Home",
    ...
    hero: {
      ...
      description:
        "PETS & DOGUE is een internationaal luxe dierenmagazine dat de schoonheid, persoonlijkheid, stijl en verhalen van dieren over de hele wereld viert."
    },
    story: {
      title: "Ons verhaal",
      p1:
    ...
    mission: {
      title: "Onze missie",
      description:
        "Het meest prestigieuze dierenmagazine ter wereld creëren en dierenliefhebbers, fotografen, kunstenaars, merken en enthousiastelingen uit alle hoeken van de wereld samenbrengen."
    },
    contact: {
      title: "Contact",
      p1:
  ...
  pl: {
    meta: {
      title: "O nas — PETS & DOGUE",
      description:
        "Dowiedz się więcej o PETS & DOGUE, naszej historii, misji i przyszłości."
    },
    nav: {
      home: "Strona główna",
    ...
    hero: {
      title: "O PETS & DOGUE",
      description:
        "PETS & DOGUE to międzynarodowy luksusowy magazyn o zwierzętach, celebrujący ich piękno, osobowość, styl i historie z całego świata."
    },
    story: {
    ...
    mission: {
      title: "Nasza misja",
      description:
        "Stworzyć najbardziej prestiżowy na świecie magazyn poświęcony zwierzętom, łączący miłośników zwierząt, fotografów, artystów, marki i entuzjastów z całego świata."
    },
    contact: {
      title: "Kontakt",
      p1:
  ...
  cs: {
    meta: {
      title: "O nás — PETS & DOGUE",
      description:
        "Zjistěte více o PETS & DOGUE, našem příběhu, poslání a budoucnosti."
    },
    nav: {
      home: "Domů",
    ...
    hero: {
      title: "O PETS & DOGUE",
      description:
        "PETS & DOGUE je mezinárodní luxusní magazín o zvířatech, který oslavuje jejich krásu, osobnost, styl a příběhy z celého světa."
    },
    story: {
      title: "Náš příběh",
      p1:
    ...
    mission: {
      title: "Naše poslání",
      description:
        "Vytvořit nejprestižnější magazín na světě věnovaný zvířatům a spojovat milovníky zvířat, fotografy, umělce, značky a nadšence ze všech koutů světa."
    },
    contact: {
      title: "Kontakt",
      p1:
  ...
  sk: {
    meta: {
      title: "O nás — PETS & DOGUE",
      description:
        "Zistite viac o PETS & DOGUE, našom príbehu, poslaní a budúcnosti."
    },
    nav: {
      home: "Domov",
    ...
    hero: {
      title: "O PETS & DOGUE",
      description:
        "PETS & DOGUE je medzinárodný luxusný magazín o zvieratách, ktorý oslavuje ich krásu, osobnosť, štýl a príbehy z celého sveta."
    },
    story: {
      title: "Náš príbeh",
      p1:
    ...
    mission: {
      title: "Naše poslanie",
      description:
        "Vytvoriť najprestížnejší magazín na svete venovaný zvieratám a spájať milovníkov zvierat, fotografov, umelcov, značky a nadšencov zo všetkých kútov sveta."
    },
    contact: {
      title: "Kontakt",
      p1:
  ...
  hu: {
    meta: {
      ...
      description:
        "Tudjon meg többet a PETS & DOGUE történetéről, küldetéséről és jövőjéről."
    },
    nav: {
      home: "Kezdőlap",
    ...
    hero: {
      ...
      description:
        "A PETS & DOGUE egy nemzetközi luxus állatmagazin, amely a világ állatainak szépségét, személyiségét, stílusát és történeteit ünnepli."
    },
    story: {
      title: "Történetünk",
      p1:
    ...
    mission: {
      title: "Küldetésünk",
      description:
        "A világ legrangosabb, állatoknak szentelt magazinjának létrehozása, amely összehozza az állatbarátokat, fotósokat, művészeket, márkákat és rajongókat a világ minden tájáról."
    },
    contact: {
      title: "Kapcsolat",
      p1:
  ...
  ro: {
    meta: {
      title: "Despre noi — PETS & DOGUE",
      description:
        "Află mai multe despre PETS & DOGUE, povestea, misiunea și viitorul nostru."
    },
    nav: {
      home: "Acasă",
    ...
    hero: {
      ...
      description:
        "PETS & DOGUE este o revistă internațională de lux dedicată animalelor, celebrând frumusețea, personalitatea, stilul și poveștile lor din întreaga lume."
    },
    story: {
    ...
    mission: {
      ...
      description:
        "Să creăm cea mai prestigioasă revistă din lume dedicată animalelor, reunind iubitori de animale, fotografi, artiști, branduri și pasionați din toate colțurile globului."
    },
    contact: {
      title: "Contact",
      p1:
  ...
  bg: {
    meta: {
      title: "За нас — PETS & DOGUE",
      description:
        "Научете повече за PETS & DOGUE, нашата история, мисия и бъдеще."
    },
    nav: {
      home: "Начало",
    ...
    hero: {
      title: "За PETS & DOGUE",
      description:
        "PETS & DOGUE е международно луксозно списание за животни, което празнува красотата, характера, стила и историите на животни от цял свят."
    },
    story: {
    ...
    mission: {
      title: "Нашата мисия",
      description:
        "Да създадем най-престижното списание в света, посветено на животните, обединявайки любители на животни, фотографи, артисти, марки и ентусиасти от цял свят."
    },
    contact: {
      title: "Контакт",
      p1:
  ...
  el: {
    meta: {
      title: "Σχετικά — PETS & DOGUE",
      description:
        "Μάθετε περισσότερα για το PETS & DOGUE, την ιστορία, την αποστολή και το μέλλον μας."
    },
    nav: {
      home: "Αρχική",
    ...
    hero: {
      ...
      description:
        "Το PETS & DOGUE είναι ένα διεθνές πολυτελές περιοδικό για ζώα που γιορτάζει την ομορφιά, την προσωπικότητα, το στυλ και τις ιστορίες ζώων από όλο τον κόσμο."
    },
    story: {
      title: "Η ιστορία μας",
      p1:
    ...
    mission: {
      ...
      description:
        "Να δημιουργήσουμε το πιο αναγνωρισμένο περιοδικό στον κόσμο αφιερωμένο στα ζώα, ενώνοντας φιλόζωους, φωτογράφους, καλλιτέχνες, brands και λάτρεις των ζώων από κάθε γωνιά του πλανήτη."
    },
    contact: {
      title: "Επικοινωνία",
      p1:
  ...
  sv: {
    meta: {
      title: "Om oss — PETS & DOGUE",
      description:
        "Läs mer om PETS & DOGUE, vår historia, vårt uppdrag och vår framtid."
    },
    nav: {
      home: "Hem",
    ...
    hero: {
      title: "Om PETS & DOGUE",
      description:
        "PETS & DOGUE är ett internationellt lyxmagasin för djur som hyllar skönhet, personlighet, stil och berättelser om djur från hela världen."
    },
    story: {
      title: "Vår historia",
      p1:
    ...
    mission: {
      title: "Vårt uppdrag",
      description:
        "Att skapa världens mest prestigefyllda magasin tillägnat djur och förena djurälskare, fotografer, konstnärer, varumärken och entusiaster från hela världen."
    },
    contact: {
      title: "Kontakt",
      p1:
  ...
  da: {
    meta: {
      title: "Om os — PETS & DOGUE",
      description:
        "Læs mere om PETS & DOGUE, vores historie, mission og fremtid."
    },
    nav: {
      home: "Forside",
    ...
    hero: {
      title: "Om PETS & DOGUE",
      description:
        "PETS & DOGUE er et internationalt luksusmagasin om dyr, der fejrer skønhed, personlighed, stil og historier om dyr fra hele verden."
    },
    story: {
    ...
    mission: {
      title: "Vores mission",
      description:
        "At skabe verdens mest prestigefyldte magasin dedikeret til dyr og samle dyreelskere, fotografer, kunstnere, brands og entusiaster fra alle dele af verden."
    },
    contact: {
      title: "Kontakt",
      p1:
  ...
  no: {
    meta: {
      title: "Om oss — PETS & DOGUE",
      description:
        "Les mer om PETS & DOGUE, vår historie, vårt oppdrag og vår fremtid."
    },
    nav: {
      home: "Hjem",
    ...
    hero: {
      title: "Om PETS & DOGUE",
      description:
        "PETS & DOGUE er et internasjonalt luksusmagasin om dyr som feirer skjønnhet, personlighet, stil og historier om dyr fra hele verden."
    },
    story: {
      title: "Vår historie",
      p1:
    ...
    mission: {
      title: "Vårt oppdrag",
      description:
        "Å skape verdens mest prestisjefylte magasin dedikert til dyr og samle dyreelskere, fotografer, kunstnere, merkevarer og entusiaster fra hele verden."
    },
    contact: {
      title: "Kontakt",
      p1:
    ...
    meta: {
      title: "Tietoa meistä — PETS & DOGUE",
      description:
        "Lue lisää PETS & DOGUEsta, tarinastamme, tehtävästämme ja tulevaisuudestamme."
    },
    nav: {
      home: "Etusivu",
    ...
    hero: {
      ...
      description:
        "PETS & DOGUE on kansainvälinen luksuseläinlehti, joka juhlistaa eläinten kauneutta, persoonallisuutta, tyyliä ja tarinoita eri puolilta maailmaa."
    },
    story: {
      title: "Tarinamme",
      p1:
    ...
    mission: {
      title: "Tehtävämme",
      description:
        "Luoda maailman arvostetuin eläimille omistettu lehti ja yhdistää eläinten ystävät, valokuvaajat, taiteilijat, brändit ja eläinharrastajat kaikkialta maailmasta."
    },
    contact: {
      title: "Yhteystiedot",
      p1:
  ...
  tr: {
    meta: {
      ...
      description:
        "PETS & DOGUE, hikâyemiz, misyonumuz ve geleceğimiz hakkında daha fazla bilgi edinin."
    },
    nav: {
      home: "Ana sayfa",
    ...
    hero: {
      ...
      description:
        "PETS & DOGUE, dünyanın dört bir yanındaki hayvanların güzelliğini, kişiliğini, stilini ve hikâyelerini kutlayan uluslararası bir lüks hayvan dergisidir."
    },
    story: {
      title: "Hikâyemiz",
      p1:
    ...
    mission: {
      title: "Misyonumuz",
      description:
        "Hayvanlara adanmış dünyanın en prestijli dergisini yaratmak ve dünyanın dört bir yanından hayvanseverleri, fotoğrafçıları, sanatçıları, markaları ve hayvan tutkunlarını bir araya getirmek."
    },
    contact: {
      title: "İletişim",
      p1:
  ...
  ar: {
    meta: {
      title: "عن المجلة — PETS & DOGUE",
      description:
        "تعرّف أكثر على PETS & DOGUE وقصتنا ورسالتنا ومستقبلنا."
    },
    nav: {
      home: "الرئيسية",
    ...
    hero: {
      title: "عن PETS & DOGUE",
      description:
        "PETS & DOGUE مجلة عالمية فاخرة عن الحيوانات تحتفي بجمالها وشخصياتها وأناقتها وقصصها من جميع أنحاء العالم."
    },
    story: {
      title: "قصتنا",
      p1:
    ...
    mission: {
      title: "رسالتنا",
      description:
        "إنشاء أرقى مجلة في العالم مخصصة للحيوانات، تجمع محبي الحيوانات والمصورين والفنانين والعلامات التجارية والمهتمين بالحيوانات من جميع أنحاء العالم."
    },
    contact: {
      title: "اتصل بنا",
      p1:
  ...
  hi: {
    meta: {
      title: "हमारे बारे में — PETS & DOGUE",
      description:
        "PETS & DOGUE, हमारी कहानी, मिशन और भविष्य के बारे में अधिक जानें।"
    },
    nav: {
      home: "होम",
    ...
    hero: {
      ...
      description:
        "PETS & DOGUE एक अंतरराष्ट्रीय लक्ज़री एनिमल मैगज़ीन है जो दुनिया भर के जानवरों की खूबसूरती, व्यक्तित्व, स्टाइल और कहानियों का उत्सव मनाती है।"
    },
    story: {
      title: "हमारी कहानी",
      p1:
    ...
    mission: {
      title: "हमारा मिशन",
      description:
        "जानवरों को समर्पित दुनिया की सबसे प्रतिष्ठित मैगज़ीन बनाना और दुनिया भर के पशु प्रेमियों, फोटोग्राफर्स, कलाकारों, ब्रांड्स और पशु उत्साही लोगों को एक साथ लाना।"
    },
    contact: {
      title: "संपर्क",
      p1:
