...
(function () {
  ...
  const SUPPORTED_LANGUAGES =
    new Set(LANGUAGE_OPTIONS.map(item => item[0]));
  ...
  const TOP_KEYS = [
    "petFriendly","discounts","help","community","marketplace"
  ];

  const BOTTOM_KEYS = [
    "edition","coverStars","contests","articles","photos","fashion","health"
  ];

  const MENU_KEYS = [
    "petFriendly","discounts","help","community","marketplace",
    "advertise","edition","coverStars","contests","articles",
    "photos","fashion","health"
  ];

  const MENU_IMAGES = {
    petFriendly:"https://images.unsplash.com/photo-1516734212186-a967f81ad0d7?auto=format&fit=crop&w=900&q=82",
    discounts:"https://images.unsplash.com/photo-1548199973-03cce0bbc87b?auto=format&fit=crop&w=900&q=82",
    help:"https://images.unsplash.com/photo-1583337130417-3346a1be7dee?auto=format&fit=crop&w=900&q=82",
    community:"https://images.unsplash.com/photo-1558788353-f76d92427f16?auto=format&fit=crop&w=900&q=82",
    marketplace:"https://images.unsplash.com/photo-1601758228041-f3b2795255f1?auto=format&fit=crop&w=900&q=82",
    advertise:"https://images.unsplash.com/photo-1520607162513-77705c0f0d4a?auto=format&fit=crop&w=900&q=82",
    edition:"https://images.unsplash.com/photo-1450778869180-41d0601e046e?auto=format&fit=crop&w=900&q=82",
    coverStars:"https://images.unsplash.com/photo-1517849845537-4d257902454a?auto=format&fit=crop&w=900&q=82",
    contests:"https://images.unsplash.com/photo-1530281700549-e82e7bf110d6?auto=format&fit=crop&w=900&q=82",
    articles:"https://images.unsplash.com/photo-1511044568932-338cba0ad803?auto=format&fit=crop&w=900&q=82",
    photos:"https://images.unsplash.com/photo-1543466835-00a7907e9de1?auto=format&fit=crop&w=900&q=82",
    fashion:"https://images.unsplash.com/photo-1583511655857-d19b40a7a54e?auto=format&fit=crop&w=900&q=82",
    health:"https://images.unsplash.com/photo-1576201836106-db1758fd1c97?auto=format&fit=crop&w=900&q=82"
  };

  const STRINGS = {

    en:[
      "Open menu","Close menu","Contents","Profile","Advertise with us",
      "Language","Sign In","Join Club","Home",
      "Add Pet-Friendly to Home Screen","Keep Pet-Friendly close",
      ...
      "Pet-Friendly Places","Discounts","Help","Community","Marketplace",
      "Edition","Cover Stars","Contests","Articles","Photos","Fashion","Health"
    ],

    uk:[
      "Відкрити меню","Закрити меню","Зміст","Профіль","Реклама у нас",
      "Мова","Увійти","Вступити до клубу","Головна",
      "Додати Pet-Friendly на головний екран","Тримайте Pet-Friendly під рукою",
      ...
      "Pet-Friendly місця","Знижки","Допомога","Спільнота","Маркетплейс",
      "Видання","Зірки обкладинки","Конкурси","Статті","Фото","Мода","Здоров’я"
    ],

    ru:[
      "Открыть меню","Закрыть меню","Содержание","Профиль","Реклама у нас",
      "Язык","Войти","Вступить в клуб","Главная",
      "Добавить Pet-Friendly на главный экран","Держите Pet-Friendly под рукой",
      ...
      "Pet-Friendly места","Скидки","Помощь","Сообщество","Маркетплейс",
      "Издание","Звёзды обложки","Конкурсы","Статьи","Фото","Мода","Здоровье"
    ],

    fr:[
      "Ouvrir le menu","Fermer le menu","Sommaire","Profil","Faire de la publicité",
      "Langue","Se connecter","Rejoindre le Club","Accueil",
      "Ajouter Pet-Friendly à l’écran d’accueil","Gardez Pet-Friendly à portée de main",
      ...
      "Lieux pet-friendly","Réductions","Aide","Communauté","Marketplace",
      "Édition","Stars de couverture","Concours","Articles","Photos","Mode","Santé"
    ],

    de:[
      "Menü öffnen","Menü schließen","Inhalt","Profil","Bei uns werben",
      "Sprache","Anmelden","Club beitreten","Startseite",
      "Pet-Friendly zum Startbildschirm hinzufügen","Pet-Friendly immer griffbereit",
      ...
      "Tierfreundliche Orte","Rabatte","Hilfe","Community","Marktplatz",
      "Edition","Cover Stars","Wettbewerbe","Artikel","Fotos","Mode","Gesundheit"
    ],

    es:[
      "Abrir menú","Cerrar menú","Contenido","Perfil","Anúnciate con nosotros",
      "Idioma","Iniciar sesión","Unirse al Club","Inicio",
      "Añadir Pet-Friendly a la pantalla de inicio","Ten Pet-Friendly siempre a mano",
      ...
      "Lugares pet-friendly","Descuentos","Ayuda","Comunidad","Marketplace",
      "Edición","Estrellas de portada","Concursos","Artículos","Fotos","Moda","Salud"
    ],

    it:[
      "Apri menu","Chiudi menu","Contenuti","Profilo","Pubblicizza con noi",
      "Lingua","Accedi","Unisciti al Club","Home",
      "Aggiungi Pet-Friendly alla schermata Home","Tieni Pet-Friendly a portata di mano",
      "Aggiungi Pet-Friendly Places alla schermata Home per aprirlo con un tocco.",
      "Aggiungi","Più tardi",
      "Su iPhone: tocca Condividi, poi Aggiungi a Home.",
      "Luoghi pet-friendly","Sconti","Aiuto","Community","Marketplace",
      "Edizione","Cover Stars","Concorsi","Articoli","Foto","Moda","Salute"
    ],

    pt:[
      "Abrir menu","Fechar menu","Conteúdo","Perfil","Anuncie connosco",
      "Idioma","Entrar","Entrar no Clube","Início",
      "Adicionar Pet-Friendly ao ecrã principal","Tenha Pet-Friendly sempre à mão",
      ...
      "Locais pet-friendly","Descontos","Ajuda","Comunidade","Marketplace",
      "Edição","Estrelas de capa","Concursos","Artigos","Fotos","Moda","Saúde"
    ],

    nl:[
      "Menu openen","Menu sluiten","Inhoud","Profiel","Adverteer bij ons",
      "Taal","Inloggen","Word lid","Home",
      "Pet-Friendly aan beginscherm toevoegen","Houd Pet-Friendly dichtbij",
      ...
      "Huisdiervriendelijke plekken","Kortingen","Hulp","Community","Marktplaats",
      "Editie","Cover Stars","Wedstrijden","Artikelen","Foto’s","Mode","Gezondheid"
    ],

    pl:[
      "Otwórz menu","Zamknij menu","Spis treści","Profil","Reklamuj się z nami",
      "Język","Zaloguj się","Dołącz do klubu","Strona główna",
      "Dodaj Pet-Friendly do ekranu głównego","Miej Pet-Friendly pod ręką",
      ...
      "Miejsca przyjazne zwierzętom","Rabaty","Pomoc","Społeczność","Marketplace",
      "Edycja","Gwiazdy okładki","Konkursy","Artykuły","Zdjęcia","Moda","Zdrowie"
    ],

    cs:[
      "Otevřít menu","Zavřít menu","Obsah","Profil","Inzerujte u nás",
      "Jazyk","Přihlásit se","Vstoupit do klubu","Domů",
      "Přidat Pet-Friendly na plochu","Mějte Pet-Friendly po ruce",
      ...
      "Místa přátelská ke zvířatům","Slevy","Pomoc","Komunita","Marketplace",
      "Vydání","Hvězdy obálky","Soutěže","Články","Fotografie","Móda","Zdraví"
    ],

    sk:[
      "Otvoriť menu","Zavrieť menu","Obsah","Profil","Inzerujte u nás",
      "Jazyk","Prihlásiť sa","Vstúpiť do klubu","Domov",
      "Pridať Pet-Friendly na plochu","Majte Pet-Friendly poruke",
      ...
      "Miesta priateľské k zvieratám","Zľavy","Pomoc","Komunita","Marketplace",
      "Vydanie","Hviezdy obálky","Súťaže","Články","Fotografie","Móda","Zdravie"
    ],

    hu:[
      "Menü megnyitása","Menü bezárása","Tartalom","Profil","Hirdessen nálunk",
      "Nyelv","Bejelentkezés","Csatlakozás a klubhoz","Kezdőlap",
      "Pet-Friendly hozzáadása a kezdőképernyőhöz","Legyen kéznél a Pet-Friendly",
      ...
      "Állatbarát helyek","Kedvezmények","Segítség","Közösség","Marketplace",
      "Kiadás","Címlapsztárok","Versenyek","Cikkek","Fotók","Divat","Egészség"
    ],

    ro:[
      "Deschide meniul","Închide meniul","Cuprins","Profil","Publicitate cu noi",
      "Limbă","Autentificare","Intră în Club","Acasă",
      "Adaugă Pet-Friendly pe ecranul principal","Ține Pet-Friendly la îndemână",
      ...
      "Locuri pet-friendly","Reduceri","Ajutor","Comunitate","Marketplace",
      "Ediție","Vedete de copertă","Concursuri","Articole","Fotografii","Modă","Sănătate"
    ],

    bg:[
      "Отвори меню","Затвори меню","Съдържание","Профил","Рекламирайте при нас",
      "Език","Вход","Влезте в клуба","Начало",
      "Добавете Pet-Friendly на началния екран","Дръжте Pet-Friendly под ръка",
      ...
      "Места за любимци","Отстъпки","Помощ","Общност","Маркетплейс",
      "Издание","Звезди на корицата","Конкурси","Статии","Снимки","Мода","Здраве"
    ],

    el:[
      "Άνοιγμα μενού","Κλείσιμο μενού","Περιεχόμενα","Προφίλ","Διαφημιστείτε μαζί μας",
      "Γλώσσα","Σύνδεση","Εγγραφή στο Club","Αρχική",
      "Προσθήκη Pet-Friendly στην αρχική οθόνη","Έχετε το Pet-Friendly πάντα κοντά",
      "Προσθέστε το Pet-Friendly Places στην αρχική οθόνη.",
      "Προσθήκη","Αργότερα",
      "Σε iPhone: πατήστε Κοινή χρήση και μετά Προσθήκη στην αρχική οθόνη.",
      "Pet-friendly μέρη","Εκπτώσεις","Βοήθεια","Κοινότητα","Marketplace",
      "Έκδοση","Αστέρια εξωφύλλου","Διαγωνισμοί","Άρθρα","Φωτογραφίες","Μόδα","Υγεία"
    ],

    sv:[
      "Öppna meny","Stäng meny","Innehåll","Profil","Annonsera hos oss",
      "Språk","Logga in","Gå med i Club","Hem",
      "Lägg till Pet-Friendly på hemskärmen","Ha Pet-Friendly nära till hands",
      ...
      "Djurvänliga platser","Rabatter","Hjälp","Community","Marketplace",
      "Utgåva","Omslagsstjärnor","Tävlingar","Artiklar","Foton","Mode","Hälsa"
    ],

    da:[
      "Åbn menu","Luk menu","Indhold","Profil","Annoncér hos os",
      "Sprog","Log ind","Bliv medlem","Hjem",
      "Føj Pet-Friendly til hjemmeskærmen","Hav Pet-Friendly lige ved hånden",
      "Føj Pet-Friendly Places til hjemmeskærmen, så det altid er ét tryk væk.",
      "Tilføj","Senere",
      "På iPhone: tryk Del og vælg Føj til hjemmeskærm.",
      "Kæledyrsvenlige steder","Rabatter","Hjælp","Fællesskab","Marketplace",
      "Udgave","Forsidestjerner","Konkurrencer","Artikler","Fotos","Mode","Sundhed"
    ],

    no:[
      "Åpne meny","Lukk meny","Innhold","Profil","Annonser hos oss",
      "Språk","Logg inn","Bli med i Club","Hjem",
      "Legg Pet-Friendly til på hjemskjermen","Ha Pet-Friendly lett tilgjengelig",
      "Legg Pet-Friendly Places til på hjemskjermen.",
      "Legg til","Senere",
      "På iPhone: trykk Del og velg Legg til på Hjem-skjerm.",
      "Kjæledyrvennlige steder","Rabatter","Hjelp","Fellesskap","Marketplace",
      "Utgave","Forsidestjerner","Konkurranser","Artikler","Bilder","Mote","Helse"
    ],

    fi:[
      "Avaa valikko","Sulje valikko","Sisältö","Profiili","Mainosta kanssamme",
      "Kieli","Kirjaudu","Liity Clubiin","Koti",
      "Lisää Pet-Friendly aloitusnäyttöön","Pidä Pet-Friendly helposti saatavilla",
      "Lisää Pet-Friendly Places aloitusnäyttöön.",
      "Lisää","Myöhemmin",
      "iPhonessa: napauta Jaa ja valitse Lisää Koti-valikkoon.",
      "Lemmikkiystävälliset paikat","Alennukset","Apua","Yhteisö","Marketplace",
      "Julkaisu","Kansitähdet","Kilpailut","Artikkelit","Kuvat","Muoti","Terveys"
    ],

    tr:[
      "Menüyü aç","Menüyü kapat","İçindekiler","Profil","Bizimle reklam verin",
      "Dil","Giriş yap","Club'a katıl","Ana sayfa",
      "Pet-Friendly’yi ana ekrana ekle","Pet-Friendly her zaman elinizin altında",
      "Pet-Friendly Places’ı ana ekranınıza ekleyin.",
      "Ekle","Daha sonra",
      "iPhone’da: Paylaş’a dokunun, ardından Ana Ekrana Ekle’yi seçin.",
      "Evcil hayvan dostu yerler","İndirimler","Yardım","Topluluk","Marketplace",
      "Edisyon","Kapak yıldızları","Yarışmalar","Makaleler","Fotoğraflar","Moda","Sağlık"
    ],

    ar:[
      "فتح القائمة","إغلاق القائمة","المحتويات","الملف الشخصي","أعلن معنا",
      "اللغة","تسجيل الدخول","انضم إلى النادي","الرئيسية",
      "أضف Pet-Friendly إلى الشاشة الرئيسية","اجعل Pet-Friendly قريبًا دائمًا",
      ...
      "أماكن صديقة للحيوانات","الخصومات","المساعدة","المجتمع","السوق",
      "الإصدار","نجوم الغلاف","المسابقات","المقالات","الصور","الموضة","الصحة"
    ],

    hi:[
      "मेनू खोलें","मेनू बंद करें","विषय सूची","प्रोफ़ाइल","हमारे साथ विज्ञापन करें",
      "भाषा","साइन इन","क्लब में शामिल हों","होम",
      "Pet-Friendly को होम स्क्रीन पर जोड़ें","Pet-Friendly को पास रखें",
      ...
      "पालतू-अनुकूल स्थान","छूट","मदद","समुदाय","मार्केटप्लेस",
      "संस्करण","कवर स्टार्स","प्रतियोगिताएँ","लेख","फोटो","फैशन","स्वास्थ्य"
    ]
  };
  ...
  function pageLanguageSelect(){
    ...
    for(const selector of selectors){
      ...
      if(element && element.id !== "pdShellLanguage"){
        return element;
      }
    }
  ...
  function persistLanguage(code){
    ...
    language = supportedLanguage(normalized)
      ? normalized
      : "en";
...
min-height:48px;
display:grid;
grid-template-columns:38px minmax(82px,1fr) 34px auto auto;
align-items:center;
gap:6px;
padding:4px 8px;
background:var(--pdh-black);
...
html[dir="rtl"] #pdLuxuryProfileMenu{
right:auto;
left:0;
}
...
#pdContentsTicker:hover{background:#0d0d0d;
}
...
html[dir="rtl"] .pd-ticker-track{
animation-name:pdTickerLeftToRight;
}

html[dir="rtl"] .pd-ticker-piece{
direction:rtl;
}

html[dir="rtl"] .pd-ticker-arrow{
transform:scaleX(-1);
}
...
display:block;
min-width:0;
padding:15px 53px 14px 14px;
background:transparent;
}

.pd-shell-card-copy h3{
margin:0;
font:400 23px/1 var(--pdh-serif);
color:#fff;
...
background:#111;
color:#fff;
box-shadow:inset 0 0 0 2px rgba(212,164,61,.95);
}
...
html[dir="rtl"] .pd-shell-card::before{
right:auto;
left:10px;
content:"←";
}

html[dir="rtl"] .pd-shell-card-copy{
...
html[dir="rtl"] #pdInstallLauncher{
right:auto;
left:14px;
}
...
#pdLuxuryMainBar{
grid-template-columns:36px minmax(68px,1fr) 30px auto auto;
gap:4px;
padding-left:6px;
padding-right:6px;
}
...
#pdLuxuryMainBar{
grid-template-columns:34px minmax(60px,1fr) 28px auto 28px;
gap:3px;
}
...
`;
  ...
  function createHomeImage(){
    ...
    if(
      !isHome() ||
      document.getElementById("pdHomeHeaderImage")
    ){
      return;
    }
  ...
  function specialIcon(key){
    ...
    if(key === "petFriendly"){
      return '<span class="pd-inline-emoji" aria-hidden="true">🐾</span>';
    }

    if(key === "help"){
      return '<span class="pd-inline-emoji" aria-hidden="true">❤️</span>';
    }
...
<span>
${esc(chooseLanguage[language] || chooseLanguage.en)}
</span>
...
`;
  ...
  function renderTicker(){
    ...
    const ticker = document.getElementById("pdContentsTicker");

    if(!ticker){
      return;
    }

    const piece = tickerPiece();
...
`;
    ...
    ticker.setAttribute(
      "aria-label",
      text.contents + ". " +
      (DISCOVER_TEXT[language] || DISCOVER_TEXT.en)
    );
  }

  function createTicker(){

    let ticker = document.getElementById("pdContentsTicker");
    ...
    const header = document.getElementById("pdLuxuryHeader");
...
`;
    ...
    document
      .getElementById("pdShellLanguage")
      ?.addEventListener(
        "change",
        event => {
  ...
  function openSideMenu(){
    ...
    const menu =
      document.getElementById("pdShellMenu");

    const overlay =
      document.getElementById("pdShellOverlay");
...
/* =========================================================
   ISSUE 01 — MISO MULTILINGUAL BRIDGE
   Added after the restored approved shell.
   Does NOT alter header, Contents or Ask Miso design.
   ========================================================= */
